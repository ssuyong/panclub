...
<div class="alert alert-info" role="alert">
   <div class="d-flex">
     ...
     <div>
       표준단가는 센터가입니다. 표준가합계는 'VAT별도' 입니다.
       <br/> 판매가격합계 및 이익은 판매출고(B)와 반품입고(B)가 제외되서 보여집니다.
     </div>
    ...
    <script type="text/javascript" src="/resources/pan/js/out-rl-tran-list.js?ver=1.0626.4"></script> 
    <script type="text/javascript" src="/resources/pan/js/common-pan.js?ver=1.1019.3"></script>
