...
<body class=" layout-fluid">
						...
						<div class="*col-md-6">
							<div class="card">
								...
								<div class="card-body">
									...
									<!-- 	<label>사용자ID</label>
										<input type="text" id="userId" class="input" aria-describedby="" placeholder="" style="width: 200px; ">
									</div> -->
									<label class="col-3 col-form-label " style="min-width: 118px; width:auto;">사용자ID</label>
                      					<div class="col">
                        					<input type="text" id="userId" class="form-control" style="width:60%; max-width:200px;" placeholder="" >
                     					 </div>
									<!-- <div style="float: left; width: 33%;">
									<label>사용자이름</label>
									<input type="text" id="userName" class="input" style="width:200px;">
									</div> -->
									<label class="col-3 col-form-label " style="min-width: 118px; width:auto;">사용자이름</label>
                      					<div class="col">
                        					<input type="text" id="userName" class="form-control" style="width:60%; max-width:200px;" placeholder="" >
                     					 </div>
                     					 <div class="col">
											<label class="form-check form-check-inline mr-3">
											 <input class="form-check-input" type="checkbox" id="validChk" name="Y"  checked> 사용
											</label>
											<label class="form-check form-check-inline mr-3"> 
											<input class="form-check-input" type="checkbox" id="nvalidChk" name="N" >사용안함
											</label> 
										</div>
									
									
									<!-- <div style="float: left; width: 33%;display: flex; ">
									<label style=" padding-right:50px"> 사용유무 조회</label>
									
											<label>사용</label>
											<input type="checkbox" id="validChk" value="Y" checked>
											<label style=" padding-left:30px ">사용안함</label>
											<input type="checkbox" id="nvalidChk" value="N"> -->
	...
	<script type="text/javascript"
		src="/resources/pan/js/user-list.js?ver=4.0210.3"></script>
