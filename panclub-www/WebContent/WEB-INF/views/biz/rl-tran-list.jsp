            ...
            <div class="*col-md-6">
              <div class="card">
                ...
                <div class="form-group mb-3 row">
                 ...
                 <label class="col-3 col-form-label " style="min-width: 70px; width: auto; margin-left:70px;">유형</label>
					<div class="col"  style="display: contents;">
						<select id=ledgType class="form-select" style="width: auto; min-width: 100px;">
						 <option value=""></option>
						<!--  <option value="입고">입고</option> -->
						<option value="출고">출고(반입포함)</option>
						<!--  <option value="반출">반출</option> -->
						 <option value="반입">반입</option>
						 <option value="판매출고">판매출고(반품입고포함)</option>
						 </select>       
						 
            <label class="col-3 col-form-label " style="min-width: 70px; width: auto;margin-left: 70px;">일반/보험</label>
					<div class="col"  style="display: contents;">
               ...
               <label class="col-3 col-form-label " style="min-width: 118px; width:auto; margin-left: 70px;">영업대표</label>
	                      <div class="col" style="display: contents;">
	            ...
	            <label class="col-3 col-form-label " style="min-width: 118px; width:auto; margin-left: 70px;">세금계산서등록여부</label>
	                      <div class="col" style="display: contents;">
	                      	<select id="taxBillRegYN" class="form-select" style="display:initial;width:auto; padding:2px 20px 2px 0; " disabled>
	                          <option value=""></option>
              ...
              <div class="form-group mb-3 row">
              	...
              	<div style="margin : 2px 0px 0;">
	               	...
	               	<input type="button" class="btn btn-secondary"  onclick="whUpProc('/order/clGroupAdd2')" value="기결">
	                 	...
	                 	<input type="button" id="btnRegTaxBill" class="btn btn-secondary"  onclick="taxBillReg()" value="세금계산서등록" disabled>                 	
	               	</span>
	               	<span>*거래처,유형(판매출고),세금계산서등록여부(미등록) 입력 후 조회시 활성화*</span>
                </div>		
...
<div id="dialogPrint-form" title="파일 저장" style="display:none;">
  <div id="contents720">
    ...
    <script type="text/javascript" src="/resources/pan/js/rl-tran-list.js?ver=1.0626.4"></script> 
