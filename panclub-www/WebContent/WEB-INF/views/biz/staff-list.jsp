	...
	<div class="page">
		...
		<div class="page-wrapper">
			...
			<div style="padding: 0 0 10px 14px;">
				<button class="btn btn-primary" id="btnStaffFind">조회</button>
								...
								<div class="card-body">
									...
									<div class="form-group mb-3 row">
										<label class="col-3 col-form-label"
											style="min-width: 118px; width: auto;">이름</label>
										<div class="col">
											<input type="text" id="name" class="form-control"
												style="width: 60%; max-width: 300px;" placeholder="">
										</div>
										<label class="col-3 col-form-label"
											style="min-width: 118px; width: auto;">사번</label>
										<div class="col">
											<input type="text" id="empNo" class="form-control"
												style="width: 60%; max-width: 300px;" placeholder="">
										</div>
										<label class="col-3 col-form-label "
											style="min-width: 118px; width: auto;">이메일</label>
										<div class="col">
											<input type="text" id="offMail" class="form-control"
												style="width: 60%; max-width: 300px;" placeholder="">
										</div>
										<label class="col-3 col-form-label "
											style="min-width: 118px; width: 80px;">재직상태</label>
										<div class="col">
											<select id= "emStatus" class="form-select" style="width:80px; padding:2px 20px 2px 0; " >										
		...
		<script type="text/javascript"
			src="/resources/pan/js/staff-list.js?ver=5.0210.3"></script>
