...
<html>
  ...
  <body  class=" layout-fluid">
                 	...
                 	<%-- 	  <div class="form-group mb-3 row" style="padding-bottom: 20px;">
            						  ...
            						  <div class="form-group mb-3 row">
										...
										<div class="form-group mb-3 row">
											...
											<label class="col-3 col-form-label"style="min-width: 118px; width: auto;">&nbsp;</label>
											<div class="col">
												<input type="number" min="0" value="0" class="form-control"style="width: 60%; max-width: 100px; padding-right: 12px; display: none;"placeholder="" disabled>
											</div>
										</div>
            </div>
    ...
    <script type="text/javascript" src="/resources/pan/js/cust-biz.js?ver=1.0719.4"></script> 
     <script type="text/javascript" src="/resources/pan/js/common-pan.js?ver=2.0630.3"></script> 
