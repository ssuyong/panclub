          ...
          <div class="container-xl">
            ...
            <div class="*col-md-6">
              <div class="card">
						...
						<input type=hidden id="prmeYmd" value=${eYmd} >
							<div class="row" style="display: contents; width: auto;">
										...
										<div class="col" style="margin-top: 3px;">
											<label class="form-check form-check-inline" style="margin-top: 3px"> 발주처 입출고 기준 
                ...
                <div class="form-group mb-3 row">
                 <label class="col-3 col-form-label " style="min-width: 70px; width: auto; ">유형</label>
...
<div id="dialogPrint-form" title="파일 저장" style="display:none;">
  <div id="contents720">
    ...
    <script type="text/javascript" src="/resources/pan/js/transaction-list.js?ver=1.0628.3"></script> 
