...
<%@ page import="java.util.*"%>
				...
				<div class="page-header d-print-none">
					<div class="row g-2 align-items-center">
						<div class="col">
							...
							<h2 class="page-title">일별 환율 조회</h2>
						</div>
						<!-- Page title actions -->
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="form-group mb-3 row">
										<label class="col-3 col-form-label"style="min-width: 118px; width: auto;">통화</label>
										<div class="col">
											<select id="code" class="form-select"style="width: 130px; padding: 2px 20px 2px 0;">
										...
										<label class="col-3 col-form-label"
											style="*min-width: 118px; width: auto;">기준일자</label> 
 ...
 -->
		...
		<script type="text/javascript"
			src="/resources/pan/js/exchange-rate-list.js?ver=1.0315.3"></script>
