...
<html>
          ...
          <div class="container-xl">
            ...
            <div class="form-group mb-3 row">
              ...
              <div style="margin : 2px;">
                      	<button class="btn btn-outline-info" onclick="addRow3(myGridID,'last')" >행추가</button>
            			<button class="btn btn-outline-info" onclick="removeRow3()" >행삭제</button>
              </div>
            </div>  
  ...
  <!-- 부서팝업 정동근 추가 -->
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     ...
     <script type="text/javascript" src="/resources/pan/js/menu-list.js?ver=5.0213.3"></script> 
