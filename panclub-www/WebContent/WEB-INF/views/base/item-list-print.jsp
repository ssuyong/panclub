...
<html>
  <head>
    ...
    <title>  QR인쇄 </title>
     <script type="text/javascript" src="/resources/pan/js/qrcode.js"></script> 
  ...
  <!--    <style>
     ...
     <link href="/resources/pan/css/barcode.css?ver=6.0522.3" rel="stylesheet" />
  </head>
  <body  class=" layout-fluid">
              ...
              <div class="col">
                ...
                <div style="padding: 0 0 10px 14px;" >
							...
							<button class="btn btn-primary" id="download" onclick="downloadQR()">다운로드</button>
							 <input type="text" id="comCode" name="comCode" style="display: none;"  value="${comCode}" > 
							 <input type="text" id="custName" name="custName"  style="display: none;"> 
				</div>
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     ...
     <script type="text/javascript" src="/resources/pan/js/item-list-print.js?ver=1.0628.3"></script> 
