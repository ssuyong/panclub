...
<html>
  ...
  <body  class=" layout-fluid">
						...
						<div class="*col-md-6">
									...
									<div class="form-group mb-3 row">
										...
										<div class="col" style="width: auto; ">
											<input type="text" id="custCode" class="form-control"
												...
												disabled>
												<label class="form-check form-check-inline" style="margin-top: 3px; "> 대표거래처 기준
							<input class="form-check-input" type="checkbox" id="mainYN" name="mainYN" > </label>
										...
										<div style="margin: 2px 0px 0;">
											<span style="display: initial; float: right; margin-right: 0px;'">
							...
							<div id="grid_wrap" style="width: 100%; height: 70vh;"></div>
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     ...
     <script type="text/javascript" src="/resources/pan/js/otherReceivablesList.js?ver=2.1129.3"></script>
     <script type="text/javascript" src="/resources/pan/js/common-pan.js?ver=1.1129.3" defer></script>   
