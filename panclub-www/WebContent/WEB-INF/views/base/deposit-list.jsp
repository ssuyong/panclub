...
<body class=" layout-fluid">
						...
						<div class="*col-md-6">
							<div class="card">
								...
								<div class="card-body">
									...
									<input type = "text"  id ="dpDead" style="display: none;">
									...
									<label class="col-3 col-form-label"
										style="min-width: 30px; width: auto; margin-left:-50px">차량번호</label>
									<div class="col">
										<input type="text" id="carNo" class="form-control" style="width: 40%; max-width: 300px;" placeholder="">
									</div>
									<label class="col-3 col-form-label"
										style="min-width: 30px; width: auto;">입금번호</label>
									<div class="col">
										<input type="text" id="depositNo" class="form-control" style="width: 40%; max-width: 300px;" placeholder="">
									</div>
									<label class="col-3 col-form-label"
										style="min-width: 30px; width: auto;">청구그룹ID</label>
									<div class="col">
										<input type="text" id="clGroupId" class="form-control" style="width: 40%; max-width: 300px;" placeholder="">
									</div>
									<label class="col-3 col-form-label" style="min-width: 30px; width: auto;">주문그룹ID</label>
									<div class="col">
										<input type="text" id="orderGroupId" class="form-control" style="width: 40%; max-width: 300px;" placeholder="">
									</div>
								</div>	
									<div class="form-group mb-3 row">
									<label class="col-3 col-form-label" style="min-width: 30px; width: auto;">거래처</label>
										<div class="col">
										...
										<label class="col-3 col-form-label" style="min-width: 50px; width: auto;">계정</label>
										<div class="col">
											<select id="accCode" class="form-select" style="width: auto;min-width: 150px;">
												<option value=""></option>
											</select>
										</div>
										
									<label class="col-3 col-form-label" style="min-width: 50px; width: auto;">입금 구분</label>
									<div class="col">
										<select id="payType" class="form-select" style="width: auto; padding: 2px 20px 2px 0;min-width: 150px">
											<option value=""></option>
										</select>
									</div>
									
										<label class="col-3 col-form-label" style="min-width: 50px; width: auto;">카드사</label>
										<div class="col" >
											<select id="cardCom" class="form-select" style="width: auto; padding: 2px 20px 2px 0;min-width: 150px;">
												<option value=""></option>
											</select>
										</div>


										<label class="col-3 col-form-label" style="min-width: 50px; width: auto;margin-left: 0px;">계좌</label>
										 <div class="col"> 
										<select id="payCode" class="form-select" style="width: auto; padding: 2px 20px 2px 0;min-width: 150px; margin-left: 0px;">
											<option value=""></option>
										</select>
									</div>
								...
								<div class="form-group mb-3 row">	
									<div class="col">
									<button class="btn btn-outline-info" id="btnFilter1"
										onclick="myCustomFilter1()">카드대금미처리</button>
								</div>								
								<label class="col-3 col-form-label"
										style="min-width: 30px; width: auto;">비고</label>
								<div class="col">
									<input type="text" id="memo" class="form-control" style="width: 40%; max-width: 300px;" placeholder="">
								</div>	
								</div>
							...
							<div class="form-group mb-3 row">
								<div style="margin: 2px 0px 0;">
									<span> <input type="button" class="btn btn-secondary" onclick="cashChk('/base/depositAdd','CHK')" value="현금영수증발행">
									</span>
	...
	<script type="text/javascript" src="/resources/pan/js/deposit-list.js?ver=1.0429.4"></script>
	<script type="text/javascript" src="/resources/pan/js/common-pan.js?ver=1.1016.3"></script>
</body>
</html>