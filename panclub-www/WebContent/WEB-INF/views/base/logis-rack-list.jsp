...
<html>
  ...
  <body  class=" layout-fluid">
                  ...
                  <div class="form-group mb-3 row">
                     <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">창고명</label>
                      ...
                      <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">랙코드</label>
                       ...
                       <div class="col">
                        <input type="text" id="rackName" class="form-control" style="width:60%; max-width:300px;" placeholder="" >
                      </div>
	...
	<script type="text/javascript"			src="/resources/pan/js/barcodeJS.js?ver=1.0507.4"></script>
     ...
     <script type="text/javascript" src="/resources/pan/js/rack-list.js?ver=1.0408.4"></script> 
