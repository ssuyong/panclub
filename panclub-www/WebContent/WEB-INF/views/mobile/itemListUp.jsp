...
<!-- 		<a class="cblueColorFont" onclick="pageMove('new')">신규</a> -->
	...
	<div>
		<input class="cWidth60vw" id="iInput_itemListNo" placeholder="품목정리 처리번호">
		<button class ="btn btn-primary" id="iButton_itemListFind">조회</button>
		<button class ="btn btn-success" id="iButton_itemListSave">등록</button>
		</div>
	</div>
	<div class="cDiv_inputArea">
		<input  id="iInput_consignComInfo" placeholder="위탁사|코드" readonly >
		<button class ="btn btn-primary" id="iButton_consignFind">검색</button>
	</div>
	<div class="cDiv_inputArea">
		...
		<div class="cDiv_inputArea">
			...
			<table > 
				...
				<tr>
					...
					<td class="cTd_itemInfo cWidth80vw cTextalignLeft cFont13p" id="iTd_basketTable_itemNo" scope="row"></td> 
				</tr>
				<tr>
...
<!-- 		<button class ="btn btn-primary m_basketButton2">저장</button> -->
	</label>
	<label>부품수 :</label>
	...
	<div class="cDiv_basket">
			<table  id="iTable_basket"> 
				...
				<tr id="iTr_basketItemHeader" >
					...
					<td class="cTd_basket cWidth70vw cFont13p" scope="col">상품정보</th>
<!-- 					<th class="m_bt2" scope="col">수량</th> -->
					<td class="cTd_basket cWidth20vw cFont13p" scope="col">일시</th>
...
<script type="text/javascript" src="/resources/panMobile/js/itemListUp.js?ver=1.0620.4"></script> 
</html>