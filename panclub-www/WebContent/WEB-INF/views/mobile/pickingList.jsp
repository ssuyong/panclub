...
<!--  	 
 ...
 -->
	...
	<div id="iDic_pickingCategory">
		<button class ="btn btn-secondary" id="iButton_pickingPcList">주문</button>
		<button class ="btn btn-secondary" id="iButton_pickingCtList">회수</button>
		<button class ="btn btn-secondary" id="iButton_pickingStorUseList">창고</button>
 	...
 	<div class="cDiv_basket">
			<table  id="iTable_basket">  
				<tr id="iTr_basketItemHeader" >  
					...
					<td class="cTd_basket cWidth30vw cFont13p cTd_baket_type1" scope="col">요청업체</th> 
...
<script type="text/javascript" src="/resources/panMobile/js/pickingList.js?ver=6.0621.4"></script>  
</html>