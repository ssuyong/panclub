...
<body class="body" style="overscroll-behavior-y:contain;">
	...
	<div class="cDiv_inputArea">
		<label>피킹구분</label>
		<select class="cWidth50vw" id="iSelectPackingType">
			<option id="rl">출고요청</option>  
		</select>
	</div>
	...
	<div id="iDic_packingTopArea">
	 	<div>
	 		<label id="iLabel_packingType"></label>
	 		<label id="iLabel_packingReqNo"></label>
	 	</div>
	 	<div>
	 		<label id="iLabel_packingCustName"></label>  
	 	</div>
	 	 
	 	<div>
	 		<button class="btn btn-primary" id="iBtnAccept" style="display:  none;">접수</button>
	 		<button class="btn btn-primary" id="iBtnConfirm" style="display:  none;">출고처리</button>
	 		<button class="btn btn-secondary" id="iBtnReject" style="display:  none;">요청취소</button>
	...
	<div class="cDiv_basket">
			<table  id="iTable_basket"> 
				...
				<tr id="iTr_basketItemHeader" >
					...
					<td class="cTd_basket cWidth10vw cFont13p cTd_baket_type1" scope="col">패킹</th>
...
<script type="text/javascript" src="/resources/panMobile/js/packingItemList.js?ver=1.0709.4"></script> 
</html>