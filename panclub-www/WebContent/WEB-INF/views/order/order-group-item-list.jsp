                ...
                <div class="card-body">
                   ...
                   <input type="hidden" name="seqArr" id="seqArr" value="${seqArr}" >
                    ...
                    <div class="form-group mb-3" style="display: flex;">
                  		 <div style="display: flex;">
	                        ...
	                        <%-- <input type="text" id="orderNo" value="${orderNo}" class="form-control" aria-describedby="" placeholder="주문번호자동생성" style="display:initial;width:48%; max-width:300px;" disabled> --%>
	                         <input type="text" id="orderGroupId" value="${orderGroupId}" class="form-control" aria-describedby="" placeholder="주문그룹ID자동생성" style="display:initial;width:34%; max-width:200px; height: 22px" disabled>
	                         <input type="button" class="btn btn-primary w-100" style="width:90px!important; height: 22px" onclick="openOrderGroupIDDialog()"  value="주문그룹변경">
	                         <a href='/order/order-group-item-list-pop?orderGroupId=${orderGroupId}' ><span style='border:1px solid #aaa; background-color:#eee; ' alt="100개이상">대량처리</span></a>
                         </div>
                         
                         <input type="text" id="orderGroupIdSrch"   class="form-control" aria-describedby="" placeholder="주문관리ID검색" style="width:20%;  height: 22px; max-width:120px; margin-left:20px; margin-right:20px;" onKeyPress="if(event.key === 'Enter') findOrderGroup('/order/order-group-list', 1);">
                      	 <input type="text" class="form-control" aria-describedby="" placeholder="견적번호자동생성" style="display:none;width:48%; max-width:300px;" disabled>
	                      	 ...
	                      	 <label  style="min-width: 98px; width:auto; text-align:right;">작성자 :</label>
	                      	 <input type="text" id="regUserName" class="form-control" aria-describedby=""style="display:initial;width:48%; max-width:150px; height: 22px;  margin-left:10px;" disabled>
                      	 
	                      	 <label style="min-width: 98px; width:auto; text-align:right;">관리지점 :</label>
	                      	 <select id="branchCode" class="form-select" style="display: initial; width: auto; padding: 2px 20px 2px 0; height: 22px;  margin-left:10px;" disabled> 
	                          <option value=""></option> 
	                        </select> 
                       
                         
                        <label style="min-width: 118px; width:auto; text-align:right;">판매구분 :</label>
                        <label class="form-check form-check-inline" style="margin-bottom: 0px;  margin-left:10px;">
                        	<input class="form-check-input" type="radio" name="orderType"  value="1" checked onClick="click_orderType(1)"disabled >
                       		 <span class="form-check-label">직영(주문처 납품처 동일)</span>
                        </label>
                        <label class="form-check form-check-inline" style="margin-bottom: 0px;">
                            <input class="form-check-input" type="radio" name="orderType" value="2"  onClick="click_orderType(2)" disabled >
                             <span class="form-check-label">대행(주문처 납품처 상이)</span>
                        </label>
                    ...
                    <div class="form-group mb-3 row">
                      ...
                      <div class="col">
                        <input type="text" id="custCode" class="form-control" aria-describedby="" placeholder="거래처코드" style="display:initial;width:48%; max-width:100px;" value="${custCode}" required onKeyUp="findCust(this,'custName');"readonly disabled>
                        <input type="text" id="custName" class="form-control" aria-describedby="" placeholder="거래처명" style="display:initial;width:48%; max-width:200px;" readonly disabled>
                        <input type="text" id="custMgrName" class="form-control" aria-describedby="" placeholder="담당자명" style="display:initial;width:48%; max-width:100px;" value="${custCode}" required onKeyUp="findCustMgr(this,'custMgrPhone','custCode');"readonly disabled>
                        <input type="text" id="custMgrPhone" class="form-control" aria-describedby="" placeholder="전화번호" style="display:initial;width:48%; max-width:150px;" value="${custCode}" required onKeyUp=""readonly disabled>
                      </div>
                      ...
                      <div  id="supplyInfo-input" class="col" >
                        <input type="text" id="supplyCustCode" class="form-control" aria-describedby="" placeholder="거래처코드" style="display:initial;width:48%; max-width:100px;" value="${custCode}" required onKeyUp="findCust(this,'supplyCustName');"readonly disabled>
                        <input type="text" id="supplyCustName" class="form-control" aria-describedby="" placeholder="거래처명" style="display:initial;width:48%; max-width:200px;" readonly disabled>
                        <input type="text" id="supplyMgrName" class="form-control" aria-describedby="" placeholder="담당자명" style="display:initial;width:48%; max-width:100px;" value="${custCode}" required onKeyUp="findCustMgr(this,'supplyCustMgrPhone','supplyCustCode');"readonly disabled>
                        <input type="text" id="supplyMgrPhone" class="form-control" aria-describedby="" placeholder="전화번호" style="display:initial;width:48%; max-width:150px;" value="${custCode}" required onKeyUp=""dreadonly isabled disabled> 
                      </div>
 					...
 					<div class="form-group mb-3 row">
	 					<label class="col-3 col-form-label" style="min-width: 118px; width:auto;">차량정보</label>
	                      <div class="col">
	                        <input type="text" id="carNo" class="form-control" size=12 maxlength=12 style="display:initial;width:60%; max-width:150px;" placeholder="차량번호" readonly disabled>
	                        <span id="existorderNoti" style="display:none; color:red;">작성 중인 주문이 있습니다.확인하세요. <span style="color:blue;" >보기</span></span>
	                        <input type="text" id="vinNo" class="form-control" style="display:initial;width:60%; max-width:150px;" placeholder="차대번호" readonly disabled>
	                        <input type="text" id="colorCode" class="form-control" style="display:initial;width:60%; max-width:150px;" placeholder="컬러코드" readonly disabled>
	                        <input type="text" id="makerCode" class="form-control" style="display:initial;width:60%; max-width:100px;" placeholder="제조사" readonly disabled>
	                       <!--  <select id="makerCode" class="form-select" style="display:initial;width:auto; padding:2px 20px 2px 0; ">
	                          
	                        </select> -->
	                        <input type="text" id="carType" class="form-control" style="display:initial;width:60%; max-width:150px;" placeholder="차종" readonly disabled>
	                      </div>       
 					</div>
 					<div class="form-group mb-3 row">
                      ...
                      <div  id="supplyInfo-input" class="col"   style="display:none; " >
                        <input type="text" id="agencyFeeRate" class="form-control" aria-describedby="" placeholder="" style="display:initial;width:48%; max-width:100px;" readonly disabled>%
                      </div>       

                      <label id="supplyInfo-title" class="col-3 col-form-label " style="min-width: 118px; width:auto;  display:none;">부품마진율</label>
                      <div  id="supplyInfo-input" class="col"   style="display:none; "  >
                        <input type="text" id="marginRate" class="form-control" aria-describedby="" placeholder="" style="display:initial;width:48%; max-width:100px;" readonly disabled>%
                      </div>
                    ...
                    <div class="form-group mb-3 row">
                     <label class="col-3 col-form-label" style="min-width: 118px; width:auto;">비고1</label>
                      <div class="col">
                        <input type="text" id="memo1" class="form-control" style="*width:60%; max-width:560px;" placeholder="" readonly disabled>
                      </div>                     
                      <label class="col-3 col-form-label" style="min-width: 118px; width:auto; ">비고2</label>
                      <div class="col">
                        <input type="text" id="memo2" class="form-control" style="*width:60%; max-width:560px;" placeholder="" readonly  disabled>
                      </div>
                    </div>      
					...
					<%-- <div class="form-group mb-3 row">
                      ...
                      <label class="col-3 col-form-label required" style="min-width: 118px; width:auto;">보험사1 정보</label>
                      <div class="col">
                        <input type="text" id="insure1Code" class="form-control" aria-describedby="" placeholder="보험사코드" style="display:initial;width:48%; max-width:100px;" value="${custCode}" required onKeyUp="findCust(this,'insure1Name');" disabled>
                        <input type="text" id="insure1Name" class="form-control" aria-describedby="" placeholder="보험사명" style="display:initial;width:48%; max-width:200px;" readonly disabled>
                        <input type="text" id="insure1MgrName" class="form-control" aria-describedby="" placeholder="담당자명" style="display:initial;width:48%; max-width:100px;" value="${custCode}" required onKeyUp="findCustMgr(this,'insure1MgrPhone','insure1Code',0,'','insure1MgrFax');" disabled>
                        <input type="text" id="insure1MgrPhone" class="form-control" aria-describedby="" placeholder="전화번호" style="display:initial;width:48%; max-width:150px;" value="${custCode}" required onKeyUp="" disabled>
                        <input type="text" id="insure1MgrFax" class="form-control" aria-describedby="" placeholder="팩스" style="display:initial;width:48%; max-width:150px;" value="${custCode}" required onKeyUp="" disabled>
                      </div>	
                      <label class="col-3 col-form-label required" style="min-width: 118px; width:auto;">보험사2 정보</label>
                     <div class="col">
                     <input type="text" id="insure2Code" class="form-control" aria-describedby="" placeholder="보험사코드" style="display:initial;width:48%; max-width:100px;" value="${custCode}" required onKeyUp="findCust(this,'insure2Name');" disabled>
                        <input type="text" id="insure2Name" class="form-control" aria-describedby="" placeholder="보험사명" style="display:initial;width:48%; max-width:200px;" readonly disabled>
                        <input type="text" id="insure2MgrName" class="form-control" aria-describedby="" placeholder="담당자명" style="display:initial;width:48%; max-width:100px;" value="${custCode}" required onKeyUp="findCustMgr(this,'insure2MgrPhone','insure2Code',0,'','insure2MgrFax');" disabled>
                        <input type="text" id="insure2MgrPhone" class="form-control" aria-describedby="" placeholder="전화번호" style="display:initial;width:48%; max-width:150px;" value="${custCode}" required onKeyUp="" disabled>
                        <input type="text" id="insure2MgrFax" class="form-control" aria-describedby="" placeholder="팩스" style="display:initial;width:48%; max-width:150px;" value="${custCode}" required onKeyUp="" disabled>
                      </div>       
                    </div>
                     ...
                     <div class="form-group mb-3 row">
                      ...
                      <div class="col">
                        <input type="text" id="insure1AcceptNo" class="form-control" aria-describedby="" placeholder="접수번호" style="display:initial;width:48%; max-width:200px;" disabled>
                        <input type="text" id="insure1AcciRate" class="form-control" aria-describedby="" placeholder="과실율" style="display:initial;width:48%; max-width:100px;"oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  disabled>
                      
                      </div>
					  		
                      <label class="col-3 col-form-label " style="min-width: 118px; width:auto;"></label>
                      <div  id="supplyInfo-input" class="col" >
                        <input type="text" id="insure2AcceptNo" class="form-control" aria-describedby="" placeholder="접수번호" style="display:initial;width:48%; max-width:200px;" disabled>
                        <input type="text" id="insure2AcciRate" class="form-control" aria-describedby="" placeholder="과실율" style="display:initial;width:48%; max-width:100px;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" disabled>
                      </div>       
                    </div>
  					...
  					<div class="form-group mb-3" style="display: flex;">
  						<label class="col-3 col-form-label" style="min-width: 118px; width:auto;">세액유무</label>
	               		<select id="taxType" class="form-select" style="width:auto; padding:2px 25px 2px 0; height: 22px;" onChange="fn_dcProc()" disabled>
	                       <option value="1">별도</option>
	                       <option value="3">포함</option>
	                       <option value="2">무</option>
	                    </select>
	                  <label class="col-3 col-form-label " style="min-width: 98px; width:auto; text-align:right;">할인율</label>
                      <input type="text" id="dcRate" class="form-control" aria-describedby="" placeholder="할인율" style="display:initial;width:48%; max-width:100px; height: 22px;  margin-right:20px;  margin-left:10px;" " readonly disabled>
                      ...
                      <label class="col-3 col-form-label" style="min-width: 98px; width:auto; text-align:right;">공급가액</label>
                        <input type="text" id="salePrice" class="form-control" style="*width:60%; max-width:100px; text-align:right; height: 22px; margin-left:10px;" placeholder=""  disabled>         
                      <label class="col-3 col-form-label" style="min-width: 98px; width:auto; *padding-left: 240px; text-align:right;" >세액</label>
                        <input type="text" id="taxPrice" class="form-control" style="*width:60%; max-width:100px; text-align:right; height: 22px; margin-left:10px;" placeholder="" disabled>
                      <label class="col-3 col-form-label" style="min-width: 98px; width:auto; *padding-left: 240px; text-align:right;">합계</label>
                        <input type="text" id="sumPrice" class="form-control" style="*width:60%; max-width:100px; text-align:right; height: 22px; margin-left:10px;" placeholder=""  disabled>
                      </div>
                      <label class="col-3 col-form-label" style="min-width: 98px; width:auto; *padding-left: 240px; text-align:right; display:none;">한글금액</label>
                    ...
                    <div class="form-group mb-3 row">
                      <div style="margin : 2px 0px 0;">
                      	<span>
	                      	...
	                      	<input type="button" id="btnClIgnore" class="btn btn-secondary " onclick="clTypeProc('제외')" value="청구제외" hidden> 
	                      ...
	                      <!-- 	<input type="button" class="btn btn-secondary " onclick="clReq()" value="청구요청">	           -->            	
	                      	...
	                      	<input type="button" id="btnClGeneral" class="btn btn-secondary " onclick="clTypeProc('일반')" value="일반적용" > -->
	                      	<input type="button" class="btn btn-secondary " onclick="clReq()"value="청구요청">	  
	                      	<% //if(comCode.equals("ㄱ000")){ %>
	                      	<input type="button" class="btn btn-secondary " onclick="stockInRequest()"value="재고투입요청">	  
	                      	<%//} %>
...
<div id="dialogPrint-form" title="파일 저장" style="display:none;">
  ...
  <!-- 오더그룹 매칭 -->
		<div id="dialog-form-orderGroupID" title="주문그룹ID변경" style="display: none;">
			<div style="padding: 0 0 10px 14px;">
				<button class="btn btn-primary" id="btnRegGroupDialog">주문그룹변경</button>
				<button class="btn btn-primary  " id="btnCloseGroupDialog">닫기</button>		
			</div>
			<div class="page-body">
				<div class="container-xl">
					<div class="row row-cards">
						<div class="*col-md-6">
							<div class="card">
								<div class="card-body">
										<span>주문그룹ID를 선택하고 [주문그룹변경버튼] 을 누를 경우 선택한 주문그룹ID로 병합됩니다.<br></span>
										<div class="form-group mb-3 row">
											<div id="grid_wrap_orderGroupID" style="width: 99.1%; height: 35vh;"></div>
										</div>
									</div>
								</div>
							</div>
		...
		<!-- 재고투입요청 팝업 -->
		<div id="dialog-form-stockInReq" title="재고투입요청" style="display: none;">
			<div style="padding: 0 0 10px 14px;"> 
				<button class="btn btn-primary" id="iButton_stockInReq_ok">재고투입요청</button> 
				<button class="btn btn-primary" id="iButton_stockInReq_close">닫기</button>			
				<label>*투입유형 위탁은 위탁창고로 투입되며 이외의 유형은 요청한 업체의 창고로 처리됩니다.</label> 
			</div>
			<div class="page-body">
				<div class="container-xl">
					<div class="row row-cards">
						<div class="*col-md-6">
							<div class="card">
								<div class="card-body">
									<div class="form-group mb-3 row">
										<div id="grid_wrap_stockInReq" style="width: 99.1%; height: 30vh; "></div>
	...
	<%@ page import="java.io.*, java.util.* , java.text.*" %> 
		...
		<%	/* CSS/JS 파일 캐시 방지 */	
			...
			String orderGroupItemList = application.getRealPath("/resources/pan/js/order-group-item-list.js");	
			File orderGroupItemListFile = new File(orderGroupItemList);	
			Date lastModified_orderGroupItemListFile = new Date(orderGroupItemListFile.lastModified());  	
    ...
    <script type="text/javascript" src="/resources/pan/js/order-group-item-list.js?ver=<%=fmt.format(lastModified_orderGroupItemListFile)%>"></script>
