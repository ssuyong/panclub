...
<body class=" layout-fluid">
	...
	<div class="page">
		...
		<%	/* CSS/JS 파일 캐시 방지 */	
			...
			String estiList = application.getRealPath("/resources/pan/js/esti-list.js");	
			File estiListFile = new File(estiList);	
			Date lastModified_estiListFile = new Date(estiListFile.lastModified());  	
		...
		<script type="text/javascript"
			src="/resources/pan/js/esti-list.js?ver=<%=fmt.format(lastModified_estiListFile)%>"></script>
		<script type="text/javascript"
