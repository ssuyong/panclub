          ...
          <div class="container-xl">
            ...
            <div class="*col-md-6">
              <div class="card">
				...
				<label class="col-3 col-form-label " style="min-width: 70px; width: auto; margin-left : 50px;">청구요청구분</label>
										<div class="col"  style="display: contents;">
											<select id="clReqType" class="form-select" style="width: auto; padding: 2px 25px 2px 0;">
												<option value="전체"></option>
												<option value="즉시청구">즉시청구</option>
												<option value="청구대기">청구대기</option>
												<option value="미정">미정</option>
											</select>
					<label class="col-3 col-form-label " style="min-width: 70px; width: auto; margin-left : 50px;">청구진행여부</label>
										<div class="col"  style="display: contents;">
											<select id="clStatus" class="form-select" style="width: auto; padding: 2px 25px 2px 0;">
												<option value="N">미청구</option>
												<option value="Y">청구</option>
												<option value="전체"></option>
											</select>													
                      ...
                      <div class="col">
                        <input type="text" id="orderGroupId" value="${orderGroupId}" class="form-control" style="width:60%; max-width:100px;" placeholder="" >
                      </div>
 ...
 -->              </div>
			...
			<div class="form-group mb-3 row">
               <div style="margin : 2px 0px 0;">
                	<span>
                 	<input type="button" class="btn btn-secondary" onclick="reqChk('/order/clReqAdd','CHK')" value="청구진행">
                 	<input type="button" class="btn btn-secondary" onclick="reqChk('/order/clReqAdd','CHK_CANCEL')" value="진행취소">                	
                	</span>
    ...
    <script type="text/javascript" src="/resources/pan/js/cl-req-list.js?ver=1.0720.3"></script> 
