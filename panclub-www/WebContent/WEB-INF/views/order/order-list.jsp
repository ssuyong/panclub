  ...
  <body  class=" layout-fluid">
    ...
    <%@ page import="java.io.*, java.util.* , java.text.*" %> 
		...
		<%	/* CSS/JS 파일 캐시 방지 */	
			...
			String orderList = application.getRealPath("/resources/pan/js/order-list.js");	
			File orderListFile = new File(orderList);	
			Date lastModified_orderListFile = new Date(orderListFile.lastModified());  	
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     <script type="text/javascript" src="/resources/pan/js/order-list.js?ver=<%=fmt.format(lastModified_orderListFile)%>"></script> 
