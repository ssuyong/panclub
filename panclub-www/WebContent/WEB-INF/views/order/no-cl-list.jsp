...
<html>
  ...
  <body  class=" layout-fluid">
    ...
    <div class="page">
      ...
      <div class="page-wrapper">
        ...
        <div style="padding: 0 0 10px 14px;" >
            ...
            <span> &nbsp;&nbsp;&nbsp; &nbsp;       * 미청구 내역은 출고기준으로 조회됩니다.</span>
    ...
    <div class="card">
                  ...
                  <!-- <form> -->
					...
					<label class="col-3 col-form-label " style="min-width: 118px; width:auto;">주문그룹ID</label>
                      ...
                      <div class="col">
                    	...
                    	<!-- <label style="min-width: 50px; width:auto;  margin-left: 30px;" >보험여부</label>      
                      	<select id="clType">
                      		<option></option>
                      		<option>보험</option>
                      		<option>일반</option>
                      ...
                      <!-- 	<label  style="min-width: 50px; width:auto;  margin-left: 30px;">청구요청상태</label>                      
                      	<select id="clReqStatus">
                      		...
                      		<option></option>
                      		 ...
                      		 <label class="col-3 col-form-label " style="min-width: 80px; width: auto;margin ">일반/보험</label>
								<div class="col"  style="display: contents;">
			                       <select id="clType" class="form-select" style="width:20%;max-width:100px; padding: 2px 25px 2px 0;">
			                      		<option></option>
			                      		<option>보험</option>
                      					<option>일반</option>
			                      	</select>
			                      </div>
			                 <label class="col-3 col-form-label " style="min-width: 80px; width:auto;">청구요청상태</label>
			                      	<div class="col"  style="display: contents;">
			...
			<div class="form-group mb-3 row">
                <div style="margin : 2px 0px 0;">
                	<!-- <span>
                  	<input type="button" class="btn btn-secondary"  onclick="clUpProc('/order/clAdd')" value="기결취소">
    ...
    <script type="text/javascript" src="/resources/pan/js/no-cl-list.js?ver=3.1205.3"></script> 
