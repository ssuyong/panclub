                    ...
                    <div class="form-group mb-3 row">
                      <div style="margin : 2px 0px 0;">
                      	<span>
	                      	...
	                      	<input type="button" id="placeReqBig" class="btn btn-secondary"  value="발주요청">
...
<!-- 
<form id="myForm">
  <input type="text" name="orderGroupId" id="orderGroupId"/>
  <button type="button" id="submitBtn">Submit</button>
</form>

<a class="preview2" data-fancybox-type="ajax" href="/order/place-req-up" id="preview2">Preview</a> -->
    <!-- Tabler Libs JS -->
    ...
    <script type="text/javascript" src="/resources/pan/js/order-group-item-list-big.js?ver=2.1128.3"></script>
