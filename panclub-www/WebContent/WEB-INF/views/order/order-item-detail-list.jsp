...
<html>
  ...
  <body  class=" layout-fluid">
        ...
        <div style="padding: 0 0 10px 14px;" >
         ...
         <div class="page-body">
          <div class="container-xl">
            ...
            <div class="form-group mb-3 row">
            	<div class="col" >
						<label class="form-check form-check-inline" > 요청내역제외
						<input class="form-check-input" type="checkbox" id="reqIgnoreYN"
							name="reqIgnoreYN" > </label>
			    </div>
			    <label id="supplyInfo-title" class="col-3 col-form-label " style="min-width: 118px; width:auto;">발주처</label>
                      <div  id="supplyInfo-input" class="col" >
                        <input type="text" id="placeCustCode" class="form-control" aria-describedby="" placeholder="거래처코드" style="display:initial;width:48%; max-width:100px;" value="${custCode}" required onKeyUp="findCust(this,'placeCustName');">
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     <script type="text/javascript" src="/resources/pan/js/order-item-detail-list.js?ver=2.0628.3"></script> 
  		<script type="text/javascript" src="/resources/pan/js/common-pan.js?ver=1.0628.3"></script> 
