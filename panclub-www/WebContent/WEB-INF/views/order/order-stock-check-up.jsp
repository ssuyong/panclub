...
<%--        
      ...
      <div class="page-wrapper">
        ...
        <div style="padding: 0 0 10px 14px;" >
            ...
            <button class="btn btn-primary  " id="btnClose" >닫기</button>
             <span style="color:##5f94d3; font-size:0.9em">[임시저장]의 경우 주문에 반영되지 않습니다. 주문에 반영하려면 [적용]을 클릭하세요.</span>
        </div>
         ...
         <div class="page-body">
          <div class="container-xl">
            ...
            <div class="*col-md-6">
					<div id="order-dsp" class="form-group mb-3 row" style="*display:none!important;">
             ...
             <%--        <input type="hidden" id="glogenCode" value="${glogenCode}" />
                    <input type="hidden" id="partsmallCode" value="${partsmallCode}" />
                    <input type="hidden" id="hallaCode" value="${hallaCode}" />
                    <input type="hidden" id="skCode" value="${skCode}" />
                    <input type="hidden" id="dekoCode" value="${dekoCode}" />
                    <input type="hidden" id="eapsCode" value="${eapsCode}" /> --%>
                    
                    
                    <div id="order-dsp" class="form-group mb-3 row">
                    ...
                    <div class="form-group mb-3 row">
                      <div style="margin : 2px 0px 0;">
                      	<span>
	                      	<input type="button" class="btn btn-secondary" id="btnApply" onclick="placeApply('/order/orderStockCheckAdd')" value="적용"> 
	                      	<!-- <input type="button" class="btn btn-secondary" onclick="stockCheck()" value="새로고침"> -->
	                      	<input type="button" class="btn btn-secondary" onclick="findOrderImportCalc('/order/order-import-calc-list',1)" value="수입계산기" style="display:none;">
                      	</span>
                      </div>
    ...
    <!-- 수입계산기 -->
	<div id="dialog-form-orderimportcalc" title="수입계산기" style="display:none;">
	                    ...
	                    <div class="form-group mb-3 row">
	                      <div style="margin : 2px 0px 0;">
	                      	<span>
		                      	...
		                      	<input type="button" class="btn btn-secondary" id="btnApply" onclick="orderCalcApply('/order/orderImportCalcAdd')" value="적용"> 
		                      	<!-- <input type="button" class="btn btn-secondary" onclick="stockCheck()" value="새로고침"> -->		                      	
	                      	</span>
	                      </div>
	                      <div id="grid_wrap_orderimportcalc" style=" height:90%;"></div>
	                    </div>  
	                </div>
	              </div>
	            </div>
...
<!--     <script src="/resources/dist/js/tabler.min.js" defer></script>
    ...
    <script type="text/javascript" src="/resources/pan/js/order-stock-check-up.js?ver=11.0216.4"></script>
    <script type="text/javascript" src="/resources/pan/js/common-pan.js?ver=43.1120.3"></script> 
