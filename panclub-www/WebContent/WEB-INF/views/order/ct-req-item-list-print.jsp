			...
			<header>
				<div class="title">
					...
					<div class="date">
						...
						<label class="dateLabel" >요청번호: </label> <input type="text"  id="reqNo"  /><br>
				...
				<div class="container" style="justify-content: space-evenly;">
					<div class="quotation">
						<div class="cust"></div>
						<div>
							<label class="contLabel">요청담당:</label> <input type="text" id="gvMgr" disabled><br>  
							<label class="contLabel">요청메모:</label> <input type="text"  id="gvMemo" disabled><br> 
							<label class="contLabel">접수담당:</label> <input type="text"  id="procUserId" disabled><br> 
							<label class="contLabel">접수단계:</label> <input type="text"  id="procStep" disabled><br> 
							<label class="contLabel">접수일자:</label> <input type="text"  id="procDate" disabled><br> 
							<label class="contLabel">수령방법:</label> <input type="text"  id="deliWay" disabled><br> 
							<label class="contLabel" id="labelDeliType">비용:</label> <input type="text"  id="deliType" disabled><br>
							<label class="contLabel">접수메모:</label> <input type="text"  id="procMemo" disabled><br> 
						</div>						
					</div>
				...
				<div class="table">
					<div class="divTable">
						<div class="divTableHeading" id="heading">
							...
							<div class="divTableCell">재고수량</div>
							<div class="divTableCell">랙명</div>
							<div class="divTableCell">랙코드</div>
...
<!-- 	<script src="/resources/dist/js/tabler.min.js" defer></script>
	...
	<script type="module" src="/resources/pan/js/ct-req-item-list-print.js?ver=3.0607.4"></script> 
