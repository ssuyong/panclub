...
<html>
  ...
  <body  class=" layout-fluid">
                ...
                <div class="card-body">
                  <!-- <form> -->
                    <div class="form-group mb-3 row">
                      ...
                      <label class="col-3 col-form-label" style="*min-width: 118px; width:auto;">청구일</label>
                      ...
                      <div class="col">
                        <input type="text" id="clNo" class="form-control" style="width:60%; max-width:300px;" placeholder="" >
                      </div>
                </div>
    ...
    <script type="text/javascript" src="/resources/pan/js/cl-list.js?ver=1.0104.3"></script> 
