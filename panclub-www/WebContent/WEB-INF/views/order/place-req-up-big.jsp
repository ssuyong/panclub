              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3 row">
                      ...
                      <div id="grid_wrap_plrequp" style="width:80vw;height:60vh;"></div>
                    </div>  
                </div>
              </div>
            </div>
...
<!--     <script src="/resources/dist/js/tabler.min.js" defer></script>
    ...
    <script type="text/javascript" src="/resources/pan/js/place-req-up-big.js?ver=8.1219.3"></script>
    <script type="text/javascript" src="/resources/pan/js/common-pan.js?ver=1.0304.3"></script> 
