...
<html>
  ...
  <body  class=" layout-fluid">
                ...
                <div class="card-body">
                    <div class="form-group mb-3 row">                   
                      ...
                      <label class="col-3 col-form-label " style="min-width: 70px; width: auto;">기준일자  </label>
						...
						<div class="row" style="display: contents;">
                      	...
                      	<label class="col-3 col-form-label" style="min-width: 30px; width: auto;">주문처</label>
								<div class="col">
									<input type="text" id="custCode" class="form-control" aria-describedby="" placeholder="거래처코드" style="display: initial; width: 48%; max-width: 100px;"
									value="${custCode}" onKeyUp="findCust(this,'custName');" ondblclick="findCust(this,'custName',0,'Y');">
					...
					<label class="col-3 col-form-label " style="min-width: 118px; width:auto;">주문그룹ID</label>
	                 ...
	                 <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">청구그룹ID</label>
	                      <div class="col">
	                        <input type="text" id="clGroupId" class="form-control" style="width:60%; max-width:300px;" placeholder="" >
	                      </div>     
                      <!--   <label class="col-3 col-form-label " style="min-width: 50px; width:auto; margin-left:15px">관리지점</label>
 					  ...
 					  <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">주문 담당자</label>
                      <div class="col">
                        <input type="text" id="ogRegUserName" class="form-control" style="width:60%; max-width:300px;" placeholder="" >
                      </div>
                   <div class="form-group mb-3 row" style="margin-top:10px">
			           <label class="col-3 col-form-label " style="min-width: 80px; width:auto; ">청구요청여부</label>
			                <div class="col"  style="display: contents;">
			                 <select id="clReqStatus" class="form-select" style="width:20%;max-width:100px; padding: 2px 25px 2px 0;">
				                 <option></option>
				                  <option>완료</option>
			                      <option>미완료</option>                 		
			                </select>
			          		</div>     	
			          <label class="col-3 col-form-label " style="min-width: 80px; width: auto; margin-left :10px">청구여부</label>
							<div class="col"  style="display: contents;">
			                    <select id="clStatus" class="form-select" style="width:20%;max-width:100px; padding: 2px 25px 2px 0;">
			                      	<option></option>
			                      	<option>청구</option>
                      				<option>미청구</option>
			                      </select>
			                  </div>		
			          <label class="col-3 col-form-label " style="min-width: 80px; width: auto; margin-left :10px" >기결여부</label>
							<div class="col"  style="display: contents;">
			                    <select id="confYN" class="form-select" style="width:20%;max-width:100px; padding: 2px 25px 2px 0;">
			                      	<option></option>
			                      	<option>기결</option>
                      				<option>미결</option>
			                      </select>
    ...
    <script type="text/javascript" src="/resources/pan/js/insurance-status.js?ver=1.0830.3"></script> 
