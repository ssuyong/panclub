...
<body class=" layout-fluid">
	...
	<div class="page">
								...
								<div class="card-body">
									...
									<div class="form-group mb-3 row">
										...
										<label class="col-3 col-form-label"
											style="*min-width: 118px; width: auto;">견적일</label> <input
									...
									<!-- 	<div class="col" style="margin-top: 3px;">
										...
										<label class="col-3 col-form-label "
											style="*min-width: 118px; width: auto;">견적번호</label>
										<div class="col">
											<input type="text" id="estiNo" class="form-control"
										...
										<div class="col">
											<!-- <select id="custCode" class="form-select" style="width: auto; padding: 2px 20px 2px 0;">
								<option value=""></option>
							</select> -->
		...
		<%	/* CSS/JS 파일 캐시 방지 */	
			...
			String estiListMasterDetail = application.getRealPath("/resources/pan/js/esti-list-master-detail.js");	
			File estiListMasterDetailFile = new File(estiListMasterDetail);	
			Date lastModified_estiListMasterDetailFile = new Date(estiListMasterDetailFile.lastModified());  	
		...
		<script type="text/javascript"
			src="/resources/pan/js/esti-list-master-detail.js?ver=<%=fmt.format(lastModified_estiListMasterDetailFile)%>"></script>
		<script type="text/javascript"
