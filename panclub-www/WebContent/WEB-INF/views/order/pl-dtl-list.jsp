  ...
  <body  class=" layout-fluid">
					...
					<div class="form-group mb-3 row">
                      ...
                      <div class="col">
                       ...
                       <% if (("ㄱ000").equals(comCode) || ("ㅋ127").equals(comCode))  {  //ㅋ127 추가. hsg 2024.10.18%> 
						    <label class="col-3 col-form-label" style="min-width: 30px; width: auto;">요청업체</label>
							<div class="col">
	...
	<%@ page import="java.io.*, java.util.* , java.text.*" %> 
		...
		<%	/* CSS/JS 파일 캐시 방지 */	
			...
			String plDtlList = application.getRealPath("/resources/pan/js/pl-dtl-list.js");	
			File plDtlListFile = new File(plDtlList);	
			Date lastModified_plDtlListFile = new Date(plDtlListFile.lastModified());  	
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     <script type="text/javascript" src="/resources/pan/js/pl-dtl-list.js?ver=<%=fmt.format(lastModified_plDtlListFile)%>"></script> 
