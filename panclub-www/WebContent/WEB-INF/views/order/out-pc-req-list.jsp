...
<html>
  ...
  <body  class=" layout-fluid">
                  ...
                  <!-- <form> -->
                    <div class="form-group mb-3 row">
                      ...
                      <div class="col" style="width:auto; ">
                      	<select id="procState"class="form-select" style=" width:auto; padding: 2px 25px 2px 0; min-width: 80px; ">
                      		<option></option>
                      		<option>미완료</option>
                      		<option>일부완료</option>
                      		<option>완료</option>
					...
					<%-- 
                	 ...
                	 <div class="form-group mb-3 row">
                      ...
                      <div class="col" style="width:auto; ">
                      	<select id="procStep"class="form-select" style=" width:auto; padding: 2px 25px 2px 0; min-width: 80px; ">
                      		<option></option>
                      		<option>접수</option>
                      		<option>거부</option>
                      	</select>
                      ...
                      <div class="col"><input type="hidden" id="" class="form-control" style="width:40%; max-width:300px;" placeholder="" ></div>	
                      <label class="col-3 col-form-label " style="min-width: 118px; width:auto;"></label>
                      <div class="col"><input type="hidden" id="" class="form-control" style="width:40%; max-width:300px;" placeholder="" ></div>	
                      <label class="col-3 col-form-label " style="min-width: 118px; width:auto;"></label>
                      <div class="col"><input type="hidden" id="" class="form-control" style="width:40%; max-width:300px;" placeholder="" ></div>	
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     <script type="text/javascript" src="/resources/pan/js/out-pc-req-list.js?ver=1.0312.4"></script> 
