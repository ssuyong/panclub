...
<html>
  ...
  <body  class=" layout-fluid">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <!-- <form> -->
                    <div class="form-group mb-3 row">
                      ...
                      <div class="col">
						...
						<div class="col">
						 ...
						 <label id="supplyInfo-title" class="col-3 col-form-label " style="min-width: 118px; width:auto;">주문처</label>
                      <div  id="supplyInfo-input" class="col" >
                        <input type="text" id="custCode" class="form-control" aria-describedby="" placeholder="거래처코드" style="display:initial;width:48%; max-width:100px;" value="${custCode}" required onKeyUp="findCust(this,'supplyCustName');">
                        <input type="text" id="custCode" class="form-control" aria-describedby="" placeholder="거래처명" style="display:initial;width:48%; max-width:200px;" disabled>			
                	...
                	<label class="col-3 col-form-label" style="min-width: 50px; width: auto;">납품처</label>
						<div class="col">									
						<input type="text" id="supplyCustCode" class="form-control" aria-describedby="" placeholder="거래처코드" style="display: initial; width: 48%; max-width: 100px;"
							value="${custCode}" required onKeyUp="findCust(this,'supplyCustName');">
				...
				<label class="col-3 col-form-label" style="*min-width: 30px; width: auto;">담당자</label>
 				...
 				<label class="col-3 col-form-label " style="width: auto;">청구요청여부</label>
					<div class="col"  >
						<select id="clReqStatus" class="form-select" style="width: auto; padding: 2px 25px 2px 0;">
							<option value=""></option>
							<option value="미청구요청">미청구요청</option>
							<option value="일부청구요청">일부청구요청</option>
							<option value="청구요청완료">청구요청완료</option>							
						</select>			
					</div>		
            </div>
	<div class="form-group mb-3 row" style="margin-top:-10px">
	 ...
	 <%@ page import="java.io.*, java.util.* , java.text.*" %> 
		...
		<%	/* CSS/JS 파일 캐시 방지 */	
			...
			String orderGroupList = application.getRealPath("/resources/pan/js/order-group-list.js");	
			File orderGroupListFile = new File(orderGroupList);	
			Date lastModified_orderGroupListFile = new Date(orderGroupListFile.lastModified());  	
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     <script type="text/javascript" src="/resources/pan/js/order-group-list.js?ver=<%=fmt.format(lastModified_orderGroupListFile)%>"></script> 
