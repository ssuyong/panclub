    ...
    <div class="page">
      ...
      <div class="page-wrapper">
        ...
        <div style="padding: 0 0 10px 14px;" >
            ...
            <button class="btn btn-primary disabled " id="btnNew">신규견적등록</button>
        </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3 row">
                      <label class="col-3 col-form-label required" style="min-width: 118px; width:auto;">견적번호</label>
                      <div class="col">
                        <input type="text" id="estiNo" value="${estiNo}" class="form-control" aria-describedby="" placeholder="견적번호자동생성" style="display:initial;width:48%; max-width:300px;" disabled>
                      </div>    
                    ...
                    <div class="form-group mb-3 row">
                      ...
                      <div  id="supplyInfo-input" class="col" >
                        <input type="text" id="supplyCustCode" class="form-control" aria-describedby="" placeholder="거래처코드" style="display:initial;width:48%; max-width:100px;" value="${custCode}" required onKeyUp="findCust(this,'supplyCustName');"  ondblclick="findCust(this,'supplyCustName',0,'Y');">
                        ...
                        <input type="text" id="supplyCustMgrName" class="form-control" aria-describedby="" placeholder="담당자명" style="display:initial;width:48%; max-width:100px;" value="${custCode}" required onKeyUp="findCustMgr(this,'supplyCustMgrPhone','supplyCustCode');">
                    ...
                    <div class="form-group mb-3 row">
                      ...
                      <div class="col">
                        <input type="text" id="carNo" class="form-control" size=12 maxlength=100 style="display:initial;width:60%; max-width:150px;" placeholder="차량번호" >
                        <!-- <span id="existEstiNoti" style="display:none; color:red;">작성 중인 견적이 있습니다.확인하세요. <span style="color:blue;" >보기</span></span> -->
                        <input type="text" id="vinNo" class="form-control" style="display:initial;width:60%; max-width:150px;" placeholder="차대번호" >
 					...
 					<div class="form-group mb-3 row">
                      ...
                      <div class="col">
                          <input type="text" id="dcRate" class="form-control" aria-describedby="" placeholder="할인율" style="display:initial;width:48%; max-width:100px;" onChange="fn_dcProc()"oninput="this.value = this.value.replace(/[^0-9.-]/g, '').replace(/(\..*)\./g, '$1');">
                    ...
                    <div class="form-group mb-3 row"> -->
                     <label class="col-3 col-form-label" style="*min-width: 118px; width:auto;">비고1</label>
                      ...
                      <div class="col">
                        <input type="text" id="memo2" class="form-control" style="*width:60%; max-width:500px;" placeholder="" >
                      </div>
                    </div>      
 					<div class="form-group mb-3 row">
 					</div>
                    ...
                    <div class="form-group mb-3 row">
                      <div style="margin : 2px 0px 0;">
                      	<span>
	                      	<input type="button" class="btn btn-secondary disabled" onclick="order()" value="주문" id="btnOrder">
	                      	...
	                      	<!-- <input type="button" class="btn btn-secondary" onclick="removeRow1()" value="재고문의">
	                      	<input type="button" class="btn btn-secondary" onclick="removeRow1()" value="수입문의"> -->
                      	</span>
                      	<span style=" display: initial; float: right;">
							...
							<%-- <a href="/order/esti-up-print?estiNo=${estiNo}" download><button>이미지 원본 다운로드</button></a> --%>
	                       <!-- <input type="button" class="btn btn-secondary disabled" id="btnDownload" onclick="print()"value="이미지 다운">  -->	                      	
                      	</span>
                      </div>
...
<!-- 	<a href="#" class="btn" data-bs-toggle="modal" data-bs-target="#modal-simple">
	...
	<div id="dialogXls-form" title="엑셀업로드"  style="display:none;">
		  <div id="contents720">			
			<form id="addExcelForm" name="addExcelForm" enctype="multipart/form-data" method="post"  action= "esti-up-xls">
			    <div >
...
<div id="dialogPrint-form" title="파일 저장" style="display:none;">
  <div id="contents720">
    <div class="contentBox">
      ...
      <div class="form-group mb-3 row">
          <label class="col-form-label">* 특이사항이 '국내재고없음' 인경우 해당 부품은 바탕색상이 노란색으로 표시됨</label>
      </div>    
    ...
    <script type="text/javascript" src="/resources/pan/js/esti-up.js?ver=<%=fmt.format(lastModified_estiUpFile)%>"></script>
