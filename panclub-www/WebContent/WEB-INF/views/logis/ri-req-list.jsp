  ...
  <body  class=" layout-fluid">
      ...
      <div class="page-wrapper">
        ...
        <div style="padding: 0 0 10px 14px;" >
            ...
            <span style="float:right;">
	            ...
	            <label class="form-check form-check-inline" style="margin-bottom: 0px;   ">
	                 <input class="form-check-input" type="radio" name="mvWay"  value="반입" checked onClick="javascript:location.href='/logis/ri-req-list'"   >
                  ...
                  <!-- <form> -->
                    <div class="form-group mb-3 row">
                      ...
                      <label class="col-3 col-form-label" style="*min-width: 118px; width:auto;">요청일</label>
						...
						<label class="col-3 col-form-label " style="min-width: 118px; width:auto;">반입요청번호</label>
                      <div class="col">
                        <input type="text" id="riReqNo" class="form-control" style="width:60%; max-width:300px;" placeholder="" >
                      </div>						
					...
					<label class="col-3 col-form-label " style="min-width: 118px; width:auto;">주문그룹ID</label>
                      ...
                      <div class="col">
						...
						<label class="col-3 col-form-label " style="min-width: 80px; width: auto; margin-left:15px">반입방법  </label>
										<div class="col"  style="display: contents;">
											<select id="riWay" class="form-select" style="width:20%; max-width:100px; padding: 2px 25px 2px 0;">
													<option></option>
													<option>방문수거</option>
													<option>택배수거</option>
													<option>퀵수거</option>
	...
	<%@ page import="java.io.*, java.util.* , java.text.*" %> 
		...
		<%	/* CSS/JS 파일 캐시 방지 */	
			...
			String riReqList = application.getRealPath("/resources/pan/js/ri-req-list.js");	
			File riReqListFile = new File(riReqList);	
			Date lastModified_riReqListFile = new Date(riReqListFile.lastModified());  	
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     <script type="text/javascript" src="/resources/pan/js/ri-req-list.js?ver=<%=fmt.format(lastModified_riReqListFile)%>" defer></script>
     <script type="text/javascript" src="/resources/pan/js/common-pan.js?ver=<%=fmt.format(lastModified_commonPanFile)%>" defer></script> 
