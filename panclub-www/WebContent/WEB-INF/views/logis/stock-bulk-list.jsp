...
<body class=" layout-fluid">
	...
	<div class="page">
			...
			<div class="container-xl">
				...
				<div class="page-header d-print-none">
					<div class="row g-2 align-items-center">
						<div class="col">
							<!-- Page pre-title -->
							<h2 class="page-title">재고 다중품번 조회</h2>
						</div>
						<!-- Page title actions -->
					</div>
				</div>
								...
								<!-- 대량조회 -->
							  	<div id="idDiv_bulkSrch_section" style="float:left; border:1px solid #eee;height:500px; padding:0 1px; *display:none;">
								    ...
								    <nav>
								        ...
								        <div>
								        	<textarea rows="10" cols="20" class="barcodeReaderInput_bulk" style="height:59vh;border:1px solid #bbb; font-size:14px; " wrap="off" id="item_bulk" name="item_bulk" 
								        	></textarea>
								        </div>
								        <div>	
		...
		<script type="text/javascript"			src="/resources/pan/js/stock-bulk-list.js?ver=1.0724.4"></script>
