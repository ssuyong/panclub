...
<body class=" layout-fluid">
	...
	<div class="page">
							...
							<div class="card" id="idDiv_nomalSrch_section" style="display: block;">
								...
								<div class="card-body">
									...
									<div class="form-group mb-3 row">
										...
										<label class="col-3 col-form-label " style="min-width: 118px; width:auto;">창고</label>
					                      <div class="col">
					                       <select class="form-select" id="storageCode"  style="width:60%; max-width:200px;">
					                      		<option></option>
					                      	</select>
					                      </div>
					                      <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">수탁업체</label>
					                      <div class="col">
					                       <select class="form-select" id="consignCustCode"  style="width:60%; max-width:200px;">
					                      		<option></option>
					                      	</select>
					                      </div>
					                      <label class="col-3 col-form-label" style="min-width: 118px; width:auto;">비실물 제외</label>
					                      <div class="col">
					                       	<label class="form-check">
					                        <input class="form-check-input" type="checkbox" id="noRealYN" name="noRealYN">
					                        </label>
					                      </div>    
					                      <label class="col-3 col-form-label" style="min-width: 118px; width:auto;">재고0개 제외</label>
					                      <div class="col">
					                       	<label class="form-check">
					                        <input class="form-check-input" type="checkbox" id="qtyZeroYN" name="qtyZeroYN">
					                        </label>
					                      </div>    
										<!-- <label class="col-3 col-form-label"
		...
		<script type="text/javascript"			src="/resources/pan/js/stock-item-list.js?ver=1.0724.4"></script>
