  ...
  <body  class=" layout-fluid">
        ...
        <div style="padding: 0 0 10px 14px;" >
            ...
            <span style="float:right;">
				<label class="form-check form-check-inline" style="margin-bottom: 0px;">			
	                <input class="form-check-input" type="radio" name="mvWay"  value="출고" checked >
                    ...
                    <div class="form-group mb-3 row">                    
                      <label class="col-3 col-form-label" style="*min-width: 118px; width:auto;">요청일</label>
						...
						<div class="row" style="display: contents;">
						    ...
						    <!-- 
						    <div class="col"  >
							<select name=setDate id=setDate onChange="dateSetting()" class="form-select" style="*width:20%;max-width:100px; padding: 2px 25px 2px 0;">
								<option value="오늘" <c:if test="${setDate=='오늘'}"> selected </c:if> >오늘</option>
								<option value="3일이내" <c:if test="${setDate=='3일이내'}"> selected </c:if> >3일이내</option>
								<option value="5일이내" <c:if test="${setDate=='5일이내'}"> selected </c:if> >5일이내</option>
								<option value="5일초과" <c:if test="${setDate=='5일초과'}"> selected </c:if> >5일초과</option>									
							</select>
							</div> -->
						</div>
					<!-- <label class="col-3 col-form-label " style="min-width: 30px; width:auto;">미출고</label> -->
				<!-- 	  <div class="col">	      
                      <span >
						<label class="form-check form-check-inline" style="margin-bottom: 0px;">			
			                <input class="form-check-input" type="radio" name="rlDate" value="3일" >
			                <span class="form-check-label">3일</span>
			            </label>
			            <label class="form-check form-check-inline" style="margin-bottom: 0px;   ">
			                 <input class="form-check-input" type="radio" name="rlDate" value="5일" >
			                <span class="form-check-label">5일</span>
			            </label>
			            <label class="form-check form-check-inline" style="margin-bottom: 0px;   ">
			                 <input class="form-check-input" type="radio" name="rlDate"  value="5일이상" >
			                <span class="form-check-label">5일이상</span>
			            </label>
		            	</span> 
		            	  </div> -->
		            	  <div class="row" style="display: contents;">
		            	
						<label class="col-3 col-form-label " style="min-width: 118px; width:auto;">출고요청번호</label>
                      <div class="col">
                        <input type="text" id="rlReqNo" class="form-control" style="width:60%; max-width:300px;" placeholder="" >
                      </div>						
					...
					<label class="col-3 col-form-label " style="min-width: 118px; width:auto;">차량정보</label>
                      ...
                      <div class="col">
                        ...
                        <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">출고담당</label>
                      <div class="col">
                        <input type="text" id="rlMgr" class="form-control" style="width:60%; max-width:300px;" placeholder="" >
                      </div>
	 			...
	 			<div class="form-group mb-3 row" style="margin-top:10px;">                   
						...
						<label class="col-3 col-form-label " style="min-width: 80px; width: auto; margin-left:15px">출고방법  </label>
										<div class="col"  style="display: contents;">
											<select id="rlWay" class="form-select" style="width:20%; max-width:100px; padding: 2px 25px 2px 0;">
												<option></option>
												<option>일반배송</option>
												<option>입고즉시</option>
												<option>택배</option>
					...
					<label class="col-3 col-form-label " style="min-width: 80px; width: auto; margin-left:15px">청구구분</label>
										<div class="col"  style="display: contents;">
											<select id="stdClType" class="form-select" style="width:20%; max-width:100px; padding: 2px 25px 2px 0;">
												<option></option>
												<option>일반</option>
												<option>보험</option>
											</select>					
									      </div>			
					<label class="col-3 col-form-label " style="min-width: 80px; width:auto; margin-left:15px">관리지점</label>
			              <div class="col" style="display: contents;">
	...
	<%@ page import="java.io.*, java.util.* , java.text.*" %> 
		...
		<%	/* CSS/JS 파일 캐시 방지 */	
			...
			String rlReqList = application.getRealPath("/resources/pan/js/rl-req-list.js");	
			File rlReqListFile = new File(rlReqList);	
			Date lastModified_rlReqListFile = new Date(rlReqListFile.lastModified());  	
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     <script type="text/javascript" src="/resources/pan/js/rl-req-list.js?ver=<%=fmt.format(lastModified_rlReqListFile)%>"></script>
