...
<html>
  ...
  <body  class=" layout-fluid">
                ...
                <div class="card-body">
                  <!-- <form> -->
                    <div class="form-group mb-3 row">
                      ...
                      <div class="col">
                        <input type="text" id="roNo" class="form-control" style="width:60%; max-width:300px;" placeholder="" >
                      </div>
					...
					<label class="col-3 col-form-label " style="min-width: 118px; width:auto;">주문그룹ID</label>
                      <div class="col">
 					  ...
 					  <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">거래처 주문번호</label>
                      <div class="col">
                 ...
                 <div class="form-group mb-3 row">
                  <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">발주처 반출번호</label>
                      <div class="col">
                        <input type="text" id="custRoNo" class="form-control" style="width:60%; max-width:150px;" placeholder="" >
                      </div>
                 </div>
                <div class="form-group mb-3 row">
					<div style="margin: 2px 0px 0;">
						<!-- <span> 
							<input type="button" class="btn btn-secondary" onclick="openDialog1()" value="발주처입고날짜변경"> 
						</span> -->
	...
	<!-- 발주처 입고일 변경 팝업 -->
	<!-- <div id="dialog-form1" title="발주처 입고일 변경" style="display: none;">
		  <label class="col-3 col-form-label required" style="min-width: 118px; width:auto;">발주처</label>
	      <div class="col">
	        <div class="">
	        	<input type="hidden" id="popRoNoArr" value="" />
	        	<input type="hidden" id="popRoSeqArr" value="" />
	        	<input type="hidden" id="popCustCode" value="" />
	          	<input type="text" class="" id="popCustName" disabled>
	      	</div>
	  	  </div>    
		
		  <label class="col-3 col-form-label required" style="min-width: 118px; width:auto; margin-top:15px;">발주처입고일</label>
	      <div class="col">
	        <div class="tui-datepicker-input tui-datetime-input tui-has-focus">
	          <input type="text" id="popPlWhYmd" aria-label="Date-Time">
	          <span class="tui-ico-date"></span>
	      	</div>
	 ...
	 <%@ page import="java.io.*, java.util.* , java.text.*" %> 
		...
		<%	/* CSS/JS 파일 캐시 방지 */	
			...
			String roItemDtlList = application.getRealPath("/resources/pan/js/ro-item-dtl-list.js");	
			File roItemDtlListFile = new File(roItemDtlList);	
			Date lastModified_roItemDtlListFile = new Date(roItemDtlListFile.lastModified());  	
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     <script type="text/javascript" src="/resources/pan/js/ro-item-dtl-list.js?ver=<%=fmt.format(lastModified_roItemDtlListFile)%>"></script>
