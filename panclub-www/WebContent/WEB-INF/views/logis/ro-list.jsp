...
<html>
  ...
  <body  class=" layout-fluid">
                  ...
                  <!-- <form> -->
					...
					<label class="col-3 col-form-label " style="min-width: 118px; width:auto;">주문그룹ID</label>
                      ...
                      <div class="form-group mb-3 row"> 
 					  ...
 					  <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">처리자</label>
                      <div class="col">
                        <input type="text" id="roMgr" class="form-control" style="width:60%; max-width:130px;" placeholder="" >
                      </div>
				 	...
				 	<label class="col-3 col-form-label" style="*min-width: 30px; width: auto;">발주처 반출번호</label>
				            <div class="col">
				                <input type="text" id="custRoNo" class="form-control" style="width:60%; max-width:130px;" placeholder="" >
				             </div>
	...
	<div id="dialog-form-cust" title="거래처 선택" style="display:none;">
	 ...
	 <%@ page import="java.io.*, java.util.* , java.text.*" %> 
		...
		<%	/* CSS/JS 파일 캐시 방지 */	
			...
			String roList = application.getRealPath("/resources/pan/js/ro-list.js");	
			File roListFile = new File(roList);	
			Date lastModified_roListFile = new Date(roListFile.lastModified());  	
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     <script type="text/javascript" src="/resources/pan/js/ro-list.js?ver=<%=fmt.format(lastModified_roListFile)%>"></script>
