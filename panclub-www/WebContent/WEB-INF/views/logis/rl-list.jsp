...
<label class="col-3 col-form-label " style="min-width: 80px; width: auto;">기준일자  </label>
								...
								<input type=hidden id="doubleClickYN" value=${doubleClickYN} >
										<div style="width: 90px!important">
											<select id="rlDateType" class="form-select" style="width: auto; padding: 2px 25px 2px 0;">
												<option value="출고일">출고일</option>
												<option value="실제출고일">실제출고일</option>
											</select>
										</div>          
                      ...
                      <div class="col">
                        <input type="text" id="rlNo" class="form-control" style="width:60%; max-width:300px;" placeholder="" >
                      </div>
					...
					<label class="col-3 col-form-label " style="min-width: 118px; width:auto;">주문그룹ID</label>
                      ...
                      <div class="form-group mb-3 row" style="margin-top:5px;">
 					  ...
 					  <label class="col-3 col-form-label " style="min-width: 80px; width:auto;">출고담당</label>
                      <div class="col" >
                        <input type="text" id="rlMgr" class="form-control" style="width:60%; max-width:130px;" placeholder="" >
                      </div>
				      ...
				      <label class="col-3 col-form-label " style="min-width: 80px; width: auto; ">주문자</label>
				          	<div class="col"  >
				                <input type="text" id="orderUserId" class="form-control" style="width:60%; max-width:130px;" placeholder="" >
				             </div>
                      <label class="col-3 col-form-label " style="min-width: 80px; width:auto;">관리지점</label>
                      		<div class="col" >
                      			<select id="branchCode" class="form-select" style="display:initial; width:auto; padding:2px 20px 2px 0; ">
                         		 	<option value=""></option>
                        		</select>  
                    	  </div>				             
	              			<label class="col-3 col-form-label " style="min-width: 80px; width: auto;  ">출고방법</label>
							<div class="col"  >
								<select id="rlWay" class="form-select" style="width:60%; max-width:100px; padding: 2px 25px 2px 0;">
									<option></option>
									<option>일반배송</option>
									<option>입고즉시</option>
									<option>택배</option>
							...
							<label class="col-3 col-form-label " style="min-width: 80px; width: auto; ">청구구분</label>
							<div class="col"  >
								<select id="stdClType" class="form-select" style="width:60%; max-width:100px; padding: 2px 25px 2px 0;">
									<option></option>
									<option>일반</option>
									<option>보험</option>
								</select>					
					    ...
					    <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">영업대표</label>
	                      <div class="col">
	...
	<div id="dialog-form-cust" title="거래처 선택" style="display:none;">
	 ...
	 <%@ page import="java.io.*, java.util.* , java.text.*" %> 
		...
		<%	/* CSS/JS 파일 캐시 방지 */	
			...
			String rlList = application.getRealPath("/resources/pan/js/rl-list.js");	
			File rlListFile = new File(rlList);	
			Date lastModified_rlListFile = new Date(rlListFile.lastModified());  	
    ...
    <script src="/resources/dist/js/demo.min.js" defer></script>
     <script type="text/javascript" src="/resources/pan/js/rl-list.js?ver=<%=fmt.format(lastModified_rlListFile)%>"></script>
