...
<body class=" layout-fluid">
	...
	<div class="page">
			...
			<div class="container-xl">
				...
				<div class="page-header d-print-none">
					<div class="row g-2 align-items-center">
						<div class="col">
							<!-- Page pre-title -->
							<h2 class="page-title">외주 재고 이력</h2>
						</div>
						<!-- Page title actions -->
					</div>
				</div>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="form-group mb-3 row">
										<label class="col-3 col-form-label"	style="*min-width: 118px; width: auto;">발생일</label> 
										...
										<label class="col-3 col-form-label"	style="*min-width: 118px; width: auto;margin-left:100px;">제조사</label>
										<div class="col">
										...
										<div class="col">
											<input type="text" id="itemId" class="form-control"	value="${itemId}"	aria-describedby="" placeholder=""	style="width: 60%; max-width: 300px;">
										</div>
										...
										<label class="col-3 col-form-label "	style="*min-width: 118px; width: auto;">외주창고</label>
										<div class="col">
											<select id="outStorName" class="form-select" style="width: auto; padding: 2px 20px 2px 0;">
												<option value=""></option>
											</select>
										</div>
		...
		<script type="text/javascript"			src="/resources/pan/js/out-stock-actions-list.js?ver=1.1018.3"></script>
