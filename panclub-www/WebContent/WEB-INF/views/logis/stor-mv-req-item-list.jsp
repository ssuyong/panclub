              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3 row">
                      ...
                      <div class="col">
                      	 <div>   <input type="text" id="mvWay" class="form-control" style="*width:60%; max-width:700px;" placeholder="" >                </div>
                      </div>
                    ...
                    <div class="form-group mb-3 row">
                      <div style="margin : 2px 0px 0;">
                      	<span> 
	                      	<!-- <input type="button" class="btn btn-secondary" id="btnMvCnt" onclick="cntReg('/logis/storMvReqItemAdd')" value="이동수량입력"> -->  
	                      	<input type="button" class="btn btn-secondary" id="btnReg" onclick="reqSend('/logis/storMvReqItemAdd')" value="저장">
...
<!--     <script src="/resources/dist/js/tabler.min.js" defer></script>
    ...
    <script type="text/javascript" src="/resources/pan/js/stor-mv-req-item-list.js?ver=1.1219.2"></script>
