...
<html>
  <head>
	...
	<link href="/resources/pan/css/printbox.css?ver=1.0817.3" rel="stylesheet" />
...
<%--        
      ...
      <div class="page-wrapper">
       ...
       <div style="padding: 0 0 10px 14px;" >
          ...
          <!--   <button class="btn btn-primary  " id="btnClose" >닫기</button> -->
             <button class="btn btn-primary  " id="btnDateChange" >반입일 변경</button>
             <span style=" display: initial; float: right; margin-right: 50px;">
	          		
	          		<input type="button" class="btn btn-secondary" id="btnPrint" value="인쇄">               	
           		 <button class="btn btn-primary  " id="btnClose" >닫기</button>
             </span>
        </div> 
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="esti-dsp" class="form-group mb-3 row">
                      ...
                      <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">반입일</label>
                      <div class="col"><span id="riYmd"></span> </div>   
                      <input type="hidden"    id="custCode">
                  </div>
 
 					<div class="form-group mb-3 row" >
                      <label class="col-3 col-form-label required" style="min-width: 118px; width:auto;">반입담당</label>
                      <div class="col">	<input type="text" id="riMgr" class="form-control" style="display:initial;width:60%; max-width:150px;" placeholder="담당/부서" >     </div>
                      ...
                      <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">실제반입일</label>
                      <div class="col"><span id="realRiYmd"></span> </div>
                     </div> 
                     <div class="form-group mb-3 row" >
                      <label class="col-3 col-form-label " style="min-width: 118px; width:auto;">메모</label>
                      <div class="col">
                         <div>   <input type="text" id="memo1" class="form-control" style="*width:60%; max-width:300px;" placeholder="" >                </div>
                      </div>      
     ...
     <!-- 반입일 변경 팝업 -->
	<div id="dialogChangeDate" title="반입일 변경" style="display: none;">
	      ...
	      <div class="col">        
	        <div class="">
	  	    ...
	  	    <label class="col-3 col-form-label required" style="min-width: 118px; width:auto;">반입번호</label>
	  	    	 <div class="col">
	  	    	<input type="text" id="popRiNo" value="" disabled/>
	  	    	</div>		
		  <label class="col-3 col-form-label required" style="min-width: 118px; width:auto; margin-top:15px;">변경 반입일</label>
	      <div class="col">
	        <div class="tui-datepicker-input tui-datetime-input tui-has-focus">
	          <input type="text" id="popCnRiYmd" aria-label="Date-Time">
...
<!--     <script src="/resources/dist/js/tabler.min.js" defer></script>
    ...
    <%@ page import="java.io.*, java.util.* , java.text.*" %> 
		...
		<%	/* CSS/JS 파일 캐시 방지 */	
			...
			String riItemList = application.getRealPath("/resources/pan/js/ri-item-list.js");	
			File riItemListFile = new File(riItemList);	
			Date lastModified_riItemListFile = new Date(riItemListFile.lastModified());  	
			
			
			SimpleDateFormat fmt = new SimpleDateFormat("yyyyMMddHHmmssSSS");
		%>
    
    <script type="text/javascript" src="/resources/pan/js/ri-item-list.js?ver=<%=fmt.format(lastModified_riItemListFile)%>"></script>
