...
<body style="margin: 0 auto; display: table;">
	<div style="text-align: center;">
		<div class="page" style="max-width: 1200px;" id="page">
				...
				<header>
					...
					<div class="company">
						<div class="tableDiv">
							<table class="type03">
								<tr>
									<td class="th">요청 번호</td>
									<td colspan="3"><c:out value="${req.riReqNo}" /></td>
								</tr>
								<tr>
									<td class="th">요청일자</td>
								...
								<tr>
									<td class="th">반입방법</td>
									<td colspan="3"><c:out value="${req.riWay}" /></td>
								</tr>
								<tr>
									<td class="th">수신자</td>
			...
			<c:set var="sum" value="0" />
    				...
    				<c:set var="sum" value="${sum +item.salePrice *item.riReqCnt }" />
				</c:forEach>
			<div class="totalBox"  style="background-color:none;">
					...
					<div class="table">
						<div class="divTable">
							<div class="divTableHeading" id="heading">
								...
								<div class="divTableCell">출고 수량</div>
								<div class="divTableCell">반입요청 수량</div>
								<div class="divTableCell priceCell">단가</div>
								<div class="divTableCell priceCell">반입금액</div> 
								<div class="divTableCell ">발주처명</div>
								<div class="divTableCell ">창고명</div>
								<div class="divTableCell">반입번호</div>
							...
							<div class="divTableBody">
								...
								<c:forEach var="item" items="${ reqItemList}" varStatus="status">
									<div class="divTableRow">
										...
										<div class="divTableCell priceCell ">${item.riReqCnt}</div>
										<div class="divTableCell priceCell ">
												<fmt:formatNumber value="${item.salePrice}" pattern="#,###" /></div>
										<div class="divTableCell priceCell ">
											<fmt:formatNumber value="${item.salePrice *item.riReqCnt}" pattern="#,###" />
										</div>
										...
										<div class="divTableCell divTableCellLeft ">${item.riNo}</div>
									</div>
	...
	<script type="text/javascript" src="/resources/pan/js/ri-req-item-list-print.js?ver=1.0313.3"></script>
