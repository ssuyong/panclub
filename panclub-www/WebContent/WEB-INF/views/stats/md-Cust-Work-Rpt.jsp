...
<body class=" layout-fluid">
	<div class="page">
		...
		<h2 class="page-title" style="margin: 10px">거래처별 처리현황</h2>
		<div style="padding: 0 0 10px 14px;" >
            <button class="btn btn-primary" id="btnFind">조회</button>
            <a style="margin-left: 10px">※아래 발주,입고,반입 탭을 선택후 조회하면 됩니다.</a>	
        </div>
			...
			<div class="card" style="margin:  10px">
				<div class="form-group mb-3 row">
					<div id="iDiv_tabSet" style="margin: 10px">
		            	...
		            	<button class="btn btn-secondary cButton_tabSelect">반입</button> 
	...
	<%@ page import="java.io.*, java.util.* , java.text.*" %> 
			...
			<%	/* CSS/JS 파일 캐시 방지 */	
				String mdCustWorkRpt = application.getRealPath("/resources/pan/js/mdCustWorkRpt.js");	
				File mdCustWorkRptFile = new File(mdCustWorkRpt);	
				Date lastModified_mdCustWorkRptFile = new Date(mdCustWorkRptFile.lastModified());  	
...
<!-- 	<script type="text/javascript"			src="/resources/pan/js/noticePopupManager.js?ver=1.0729.4"></script> -->
	<script type="text/javascript" src="/resources/pan/js/mdCustWorkRpt.js?ver=<%=fmt.format(lastModified_mdCustWorkRptFile)%>"></script> 
