	...
	<div class="page-wrapper" >
		<div class="page" > 
			<div class="col-md-4" style="width: 100%" >
				...
				<h4 style="margin: 10px;">입금, 출금 현황</h4> 
                  	...
                  	<div class="card-header" > 
						...
						<div class="col">
							<label class="form-check form-check-inline"> 제외업체 제외
								...
								id="exceptCustYN" name="exceptCustYN">
							</label>
						</div>
		...
		<script type="text/javascript" src="/resources/pan/js/dp-wd-rpt.js?ver=4.0425.4"></script> 
