	...
	<div class="page-wrapper" >
		<div class="page" > 
			<div class="col-md-4" style="width: 100%" >
				...
				<h4 style="margin: 10px;">위탁재고 판매 현황</h4> 
...
<!-- 	                     <a style="display: initial; float: right; margin-right: 14px;"> (단위 : 천원)</a> -->  
              	...
              	<div class="alert alert-info" role="alert">
				   <div class="d-flex">
				     ...
				     <div>
				        판매가격합계 및 이익은 판매출고(B)와 반품입고(B)가 제외되서 보여집니다.
				     </div>
		...
		<script type="text/javascript" src="/resources/pan/js/outRlReport.js?ver=1.0329.4"></script> 
