...
<body class=" layout-fluid">
	...
	<div class="page">
			...
			<div class="container-xl">
				...
				<div class="page-header d-print-none">
					<div class="row g-2 align-items-center">
						<div class="col">
							<!-- Page pre-title -->
							<h2 class="page-title">재고 검색 순위</h2>
						</div>
						<!-- Page title actions -->
					</div>
				</div>
				...
				<div class="container-xl">
					<div class="row row-cards">
						...
						<div class="*col-md-6">
							...
							<div class="form-group mb-3 ">
								...
								<!-- 대량조회 END -->
								<div>
								<div id="grid_wrap" style="width: 80%; height: 70vh;"></div>
								</div>
							</div>
					<div class="alert alert-info" role="alert">
					   <div class="d-flex">
					     ...
					     <div>
					        순위는 검색기간의 전체부품의 검색순위 중 해당 부품의 순위입니다.					        
					        <br>외부업체는 관계사를 제외한 순수 외부업체를 말합니다.	전체는 내부업체 포함입니다.				        
					        <br>기본정렬을 외부업체의 검색수 순위입니다.			        
					     </div>					    
					   </div>
					</div>	
		...
		<script type="text/javascript"			src="/resources/pan/js/stock-srch-rnk.js?ver=<%=fmt.format(lastModified_stockSrchRnkFile)%>"></script>
