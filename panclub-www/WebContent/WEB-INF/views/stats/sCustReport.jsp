	...
	<div class="page-wrapper" >
		<div class="page" > 
			<div class="col-md-4" style="width: 100%" >
				...
				<h4 id="subTitle" style="margin: 10px;">거래처별 거래 현황</h4> 
...
<!-- 	                     <a style="display: initial; float: right; margin-right: 14px;"> (단위 : 천원)</a> -->  
		...
		<script type="text/javascript" src="/resources/pan/js/sCustReport.js?ver=2.0329.4"></script> 
