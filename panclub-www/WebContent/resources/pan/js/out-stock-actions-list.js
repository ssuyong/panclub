...
$(document).ready(function(){
	...
	if(document.location.hash){
        ...
        findDataToServer("/logis/out-stock-actions-list",page);
  	}
	...
	$("#btnFind").click(function(){
		...
		findDataToServer("/logis/out-stock-actions-list", 1);
	});
...
// 칼럼 레이아웃 작성
var columnLayout = [ 
	 { dataField : "created",    headerText : "발생시각", width : 200, style : "left" }
	,{ dataField : "storCode",    headerText : "창고코드", width : 56, style : "left", visible : false	}
	,{ dataField : "storName",    headerText : "창고명", width : 200, style : "left"	}
	,{ dataField : "rackCode",    headerText : "랙코드", width : 56, style : "left", visible : false	}
	,{ dataField : "rackName",    headerText : "랙명", width : 120, style : "left", visible : false	}
	,{ dataField : "className",      headerText : "구분", width : 80, editable : false }	 
	,{ dataField : "itemId",    headerText : "부품ID", width : 100} 
	,{ dataField : "itemNo",     headerText : "품번", width : 200     }
	, { dataField: "factoryNo", headerText: "공장품번", width: 120 } 
	,{ dataField : "itemName",   headerText : "상품명" , style : "left" , width : 300}
	,{ dataField : "makerCode",   headerText : "제조사코드", width : 80 }
	,{ dataField : "makerName",      headerText : "제조사명"  , width : 120, style : "left"   }
	,{ dataField : "actionType",   headerText : "작업구분코드", width : 68 , visible : false}
	,{ dataField : "actionName",      headerText : "작업구분"  , width : 100 }
	,{ dataField : "procQty",      headerText : "작업수량", width : 90 ,dataType: "numeric" ,formatString: "#,##0"  , style:"right"}
	,{ dataField : "afterQty",      headerText : "작업후수량", width : 80 ,dataType: "numeric" ,formatString: "#,##0"  , style:"right"}
	,{ dataField : "procMemo1",      headerText : "비고" , width : 300 }
	,{ dataField : "regUserName",      headerText : "작업자" , width : 68 , visible : false}
];
