...
const TAB_ENUM = {발주:'PLACE' , 입고:'WH' , 반입 : 'RI'  };
let selectTab = '';
...
function createAUIGrid()
{
	...
	const columnLayout = [  
		{ dataField : "custName",    headerText : "업체명", width : 100 , style:"left"},  
		{ dataField : "workCnt",    headerText : "등록건수", width : 100 , style:'right'
		,headerTooltip : { //마스터수
		        show : true,
		        tooltipHtml : '발주,입고,반입등에서 발주의 경우 등록한 품목의 발주번호의 수의 합계입니다'
		    }},  
