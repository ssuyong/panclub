...
var comCode = urlParams.get('comCode');
...
/*
qrCodes.forEach(function(code) {
  // QR 코드를 출력할 새로운 <div> 요소 생성
  var div = document.createElement("div");
  div.classList.add("qrcode-container"); // 원하는 CSS 클래스를 추가할 수 있습니다.
...
/*	
	...
	//img.src = "/resources/img/panclub_v1_s.png";
	img.src = "http://img.panclub.co.kr/custImg/ㄱ000.png";
	img.style.height = "16px"; // 이미지의 높이 설정
	...
	qrContainer.width = "150"
	qrContainer.height = "150"
...
var rackNameContainer = document.createElement("div");
rackNameContainer.classList.add("rackname-container");
rackNameContainer.textContent = rackName[index];
rackNameContainer.style.marginTop = "-5px";
...
parentContainer.appendChild(rackNameContainer);
...
additionalContentContainer.style.width = "200px";
...
function printQR() {
  ...
  printContent += "<style>@media print {";
   printContent += "@page { size: 60mm 40mm; margin: 0mm; }"; 
  ...
  printContent += ".rackname-container { font-size: 16px; font-weight: bold; margin-top: 10px; }";
