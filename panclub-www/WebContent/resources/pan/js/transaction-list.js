...
var columnLayout = [ 
	{  headerText : "기본정보", 
		children: [
			{ dataField: "stdYmd",        headerText: "일자"      , width: 120 , editable: false  },
			{ dataField: "stdYmd",        headerText: "거래처출고일자"      , width: 120 , editable: false  },
			{ dataField: "ledgType",        headerText: "구분"      , width: 60 , visible: false}, 		
			{ dataField: "ledgCateg",        headerText: "구분"      , width: 60   },
			{ dataField: "custCode",        headerText: "거래처코드"      , width: 120 , visible: false  }, 
			{ dataField: "custName",        headerText: "거래처명"      , width: 120 }, 
        	{ dataField: "summary",      headerText: "적요" ,      width: 120  , editable: false    
        	...
        	{ dataField: "seq",      headerText: "순번" ,      width: 60  , editable: false}, 
        	{ dataField: "carNo",      headerText: "차량번호", width : 130, editable: false }  ,
     ...
     {  headerText : "부품", 
		children: [
        	...
        	{ dataField: "itemNo",         headerText: "부품번호", width : 140, editable: false },
        	{ dataField: "itemName",         headerText: "부품명", width : 140, editable: false   },
        ]
    },
			{ dataField: "cnt",        headerText: "수량"  , width : 60, dataType: "numeric", formatString: "#,##0", style: "right", editable: false    },
        	{ dataField: "centerPrice",         headerText: "표준단가", width : 120, dataType: "numeric", formatString: "#,##0", style: "right" , editable: false },
        	{ dataField: "unitPrice",         headerText: "단가", width : 120, dataType: "numeric", formatString: "#,##0", style: "right" , editable: false },
        	{ dataField: "sumPrice",         headerText: "공급가액", width : 120, dataType: "numeric", formatString: "#,##0", style: "right" , editable: false   },
        	{ dataField: "taxPrice",         headerText: "세액", width : 120, dataType: "numeric", formatString: "#,##0", style: "right" , editable: false   },
        	{ dataField: "sumPriceTax",      headerText: "합계금액", width : 120, dataType: "numeric", formatString: "#,##0", style: "right" , editable: false }  ,
        	{ dataField: "custOrderNo",      headerText: "거래처주문번호", width : 140, editable: false }  ,
        	{ dataField: "memo",      headerText: "비고", width : 140, editable: false }  ,
        	
        	{ dataField: "orderGroupId",      headerText: "주문그룹ID", width : 120, editable: false }  ,
        	{ dataField: "clType",      headerText: "일반/보험", width : 60, editable: false }  ,
        	{ dataField: "userName",      headerText: "작성자", width : 100, editable: false }  ,
...
function createAUIGrid(columnLayout) {
	...
	AUIGrid.bind(myGridID, "cellDoubleClick", function (event) {
		...
		if (event.columnIndex == 6) {   
			...
			if (ledgType == '출고') {   
				$.fancybox.open({
				  href : '/logis/rl-item-list?rlNo='+summary, // 불러 올 주소
				  type : 'iframe',
				  width : '90%',
				  height : '90%',
				  padding :0,
			...
			if (ledgType == '입고') {   
				$.fancybox.open({
				  href : '/logis/wh-item-list?whNo='+summary    , // 불러 올 주소
				  type : 'iframe',
				  width : '90%',
				  height : '90%',
				  padding :0,
				...
				if (ledgType == '출고(반입)') {   
				$.fancybox.open({
				  href : '/logis/ri-item-list?riNo='+summary    , // 불러 올 주소
				  type : 'iframe',
				  width : '90%',
				  height : '90%',
				  padding :0,
			...
			if (ledgType == '입고(반출)') {   
				$.fancybox.open({
				  href : '/logis/ro-item-list?roNo='+summary    , // 불러 올 주소
				  type : 'iframe',
				  width : '90%',
				  height : '90%',
				  padding :0,
			...
			if (data.transactionList.length == 0){
				...
				for(i=0;i<data.transactionList.length;i++){
					list.push({
						...
						,centerPrice: data.transactionList[i].centerPrice //2023.07.13 bk centerPrice
					});		
