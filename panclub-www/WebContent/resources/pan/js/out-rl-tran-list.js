...
$(document).ready(function(){
	...
	if (lcd == 'ㄱ000' || lcd == 'ㅋ127') {  //2023.10.26. //ㅋ127 추가. hsg 2024.10.18 
		AUIGrid.showColumnByDataField(myGridID, ["custCode", "custName"]);
	} else {
		AUIGrid.hideColumnByDataField(myGridID, ["custCode", "custName"]);
	}
	
	if(lcd =='ㄱ000' || lcd == 'ㄱ121' || lcd == 'ㅋ127') {  //2024.02.19 P,그린파츠 아닌경우 판매가합계,이익 비노출 //ㅋ127 추가. hsg 2024.10.18 
...
function createAUIGrid(columnLayout) {
	...
	var footerLayout = [{
		...
		dataField: "sumSalePrice",
		positionField: "sumSalePrice",
		operation: "SUM",
		formatString: "#,##0"
		,style: "right"
	}	, {
		dataField: "profitsPrice",
		positionField: "profitsPrice",
		operation: "SUM",
		formatString: "#,##0"
		,style: "right"
	}				
