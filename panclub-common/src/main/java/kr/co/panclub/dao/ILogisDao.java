...
public interface ILogisDao {
	...
	public RlReq reqOne(HashMap<String, Object> i_param); //1개만 조회
	...
	public Rl rlOne(HashMap<String, Object> i_param);//1개만 조회
	...
	public RiReq rireqOne(HashMap<String, Object> i_param); //1개만 조회
	...
	public RoReq roReqOne(HashMap<String, Object> i_param); //1개만 조회
	...
	//--2023.09.01 아래것과 중복되어 주석처리.
	//public List<StockWr> stockWrList(HashMap<String, Object> params);       //재고입출고 리스팅 
	...
	//재고입출고처리. 2023.09.01 
	public StockWr stockWrAdd(HashMap<String, Object> params);   // 등록
	...
	public StockWrItem stockWrItemOne(HashMap<String, Object> params);       //품목1개   
	
	public StorageUseReq storageReqOne(HashMap<String, Object> i_param);  //품목1개   2023.10.04 bk
	...
	public List<SaleItemQty> rlStockList (HashMap<String,Object> i_param); // 20231123 supi 출고부품조회
	...
	public StockItemOuterNonDsp stockItemOuterNonDspAdd(HashMap<String, Object> params);   // 등록
