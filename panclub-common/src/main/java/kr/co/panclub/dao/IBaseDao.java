...
public interface IBaseDao {
	...
	public List<Menu> menuList(HashMap<String, Object> params);       //메뉴리스팅 정동근 추가
	public int menuAdd(HashMap<String, Object> params);				//메뉴추가 정동근 추가
	public int menuDel(HashMap<String, Object> params);				//메뉴추가 정동근 추가
	public int menuUpt(HashMap<String, Object> params);				//메뉴추가 정동근 추가
	
	public List<Storage> storageList(HashMap<String, Object> params);       //창고리스팅 정동근 추가
	public int storageAdd(HashMap<String, Object> params);				//창고추가 정동근 추가
	public int storageDel(HashMap<String, Object> params);				//창고추가 정동근 추가
	public int storageUpt(HashMap<String, Object> params);				//창고추가 정동근 추가
	
	public List<Rack> rackList(HashMap<String, Object> params);       //랙 리스팅 정동근 추가
	public int rackAdd(HashMap<String, Object> params);				//랙 추가 정동근 추가
	public int rackDel(HashMap<String, Object> params);				//랙 추가 정동근 추가
	public int rackUpt(HashMap<String, Object> params);				//랙 추가 정동근 추가
	//rackAdd, rackUpt, rackDel 을 아래에 하나로 처리. 2023.11.24 hsg
	...
	public int deptDel(HashMap<String, Object> params);
	public int deptUpt(HashMap<String, Object> params);
	...
	public int srUpt(HashMap<String, Object> params);
	public int srDel(HashMap<String, Object> params);
	public int srCustAdd(HashMap<String, Object> params);
	public int srCustUpt(HashMap<String, Object> params);
	public int srCustDel(HashMap<String, Object> params);
	
	public List<Deadline> deadlineList(HashMap<String, Object> params);
	public int deadlineUpt(HashMap<String, Object> params);
	
	public List<Deposit> depositList(HashMap<String, Object> params);
	public int depositAdd(HashMap<String, Object> params);
	public int depositUpt(HashMap<String, Object> params);
	public int depositUpt1(HashMap<String, Object> params);
	...
	public int withdrawUpt(HashMap<String, Object> params);
	...
	public int taxBillUpt(HashMap<String, Object> params);
	public int taxBillUptHw(HashMap<String, Object> params);
	public int taxBillFind(HashMap<String, Object> params);
	public int taxBillReset(HashMap<String, Object> params);
	public int taxBillDel(HashMap<String, Object> params);
	public List<KeyInfo> taxKeyLsit(HashMap<String, Object> i_param);
	
	public List<Notice> noticeList(HashMap<String, Object> params);       //공지사항 리스팅  	
	public Notice noticeAdd(HashMap<String, Object> params); //공지사항 등록
	public List<ExchangeRate> exRateList(HashMap<String, Object> i_param);//환율 조회
	...
	public ItemOe itemOeAdd(HashMap<String, Object> params); //부품 정품번호 2023.06.20 bk
	public List<ItemOe> itemOeList(HashMap<String, Object> i_params);//부품 정품번호 2023.06.21 bk
	
	public ItemMemo itemMemoAdd(HashMap<String, Object> params);//부품 메모 등록 20230623 bk
	public List<ItemMemo> itemMemoList(HashMap<String, Object> i_param);//부품메모목록 2023.06.23 bk
	
	public List<Storage> storageList2(HashMap<String, Object> params);//창고조회 2 (유효성체크) 20230714 bk
	public Deadline deadlineAdd(HashMap<String, Object> params);
	
	public int withdrawChk(HashMap<String, Object> params); //출금에서 현금영수증 발행 2023.09.11 bk 
	
	public List<LogisCode> logisCodeList(HashMap<String, Object> params); // 기초코드중 수령물류센터 코드 받아오는 통신 20240228 supi
	
	
	public String popupReg(HashMap<String, Object> params); //20240711 supi 팝업등록
	public List<HashMap<String, Object>> popupList(HashMap<String, Object> params); //20240711 supi 팝업조회
