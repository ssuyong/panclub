...
public interface IStatsService {
	...
	//주문분석
	public List<StockReport> stockGetReport(HashMap<String, Object> params);       // 보고서 데이터
	public List<RlReportDetailItem> stockReportT4Detail(HashMap<String, Object> params);       // 보고서의 출고상세
