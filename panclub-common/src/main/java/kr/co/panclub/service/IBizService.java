...
public interface IBizService {
	...
	public Staff staffAdd(HashMap<String, Object> params); //사원등록
	
	public List<User> userList(HashMap<String, Object> params);			//사용자목록 리스팅 정동근 추가
	public User userAdd(HashMap<String, Object> params);				//사용자추가
	
	public int menuByUserAdd(HashMap<String, Object> params);   // 사용자별메뉴 등록
	public List<MenuByUser> menuByUserList(HashMap<String, Object> params);       //사용자별메뉴 리스팅   
