...
public class EstimateItemPlaceStock {
	...
	private String estiNo;            //  varchar(50) not null,
	private String estiSeq;            //  varchar(20) not null,
	private int estiCnt;
	...
	// 추가 행 리스트
	private ArrayList<EstimateItemPlaceStock> estiStockAdd;
	// 수정 행 리스트
	private ArrayList<EstimateItemPlaceStock> estiStockUpdate;
	// 삭제 행 리스트
	private ArrayList<EstimateItemPlaceStock> estiStockRemove;
	...
	public int getEstiCnt() {
		return estiCnt;
	}

	public void setEstiCnt(int estiCnt) {
		this.estiCnt = estiCnt;
	}
	...
	public ArrayList<EstimateItemPlaceStock> getEstiStockAdd() {
		return estiStockAdd;
	}

	public void setEstiStockAdd(ArrayList<EstimateItemPlaceStock> estiStockAdd) {
		this.estiStockAdd = estiStockAdd;
	}

	public ArrayList<EstimateItemPlaceStock> getEstiStockUpdate() {
		return estiStockUpdate;
	}

	public void setEstiStockUpdate(ArrayList<EstimateItemPlaceStock> estiStockUpdate) {
		this.estiStockUpdate = estiStockUpdate;
	}

	public ArrayList<EstimateItemPlaceStock> getEstiStockRemove() {
		return estiStockRemove;
	}

	public void setEstiStockRemove(ArrayList<EstimateItemPlaceStock> estiStockRemove) {
		this.estiStockRemove = estiStockRemove;
	}
	...
	public String toString() {
		return "EstimateItemPlaceStock [workingType=" + workingType + ", db_resultCode=" + db_resultCode
				+ ", db_resultMsg=" + db_resultMsg + ", idx=" + idx + ", comCode=" + comCode + ", estiNo=" + estiNo
				+ ", estiSeq=" + estiSeq + ", estiCnt=" + estiCnt + ", placeCnt=" + placeCnt + ", whReqCnt=" + whReqCnt
				+ ", whStockCnt=" + whStockCnt + ", glogen=" + glogen + ", partsmall=" + partsmall + ", halla=" + halla
				+ ", sk=" + sk + ", center1=" + center1 + ", center2=" + center2 + ", deko=" + deko + ", eapsEU="
				+ eapsEU + ", eapsUSA=" + eapsUSA + ", regUserId=" + regUserId + ", created=" + created + ", uptUserId="
				+ uptUserId + ", modified=" + modified + ", cargoGroupCode=" + cargoGroupCode + ", dekoEuro=" + dekoEuro
				+ ", eapsEuro=" + eapsEuro + ", eapsDollar=" + eapsDollar + ", placeCustCode=" + placeCustCode
				+ ", placeCustName=" + placeCustName + ", cargoGroupName=" + cargoGroupName + ", itemId=" + itemId
				+ ", itemNo=" + itemNo + ", itemName=" + itemName + ", itemNameEn=" + itemNameEn + ", salePrice="
				+ salePrice + ", useStorageCnt=" + useStorageCnt + ", tempAdd=" + tempAdd + ", centerPrice="
				+ centerPrice + ", shareStockQty=" + shareStockQty + ", estiStockAdd=" + estiStockAdd
				+ ", estiStockUpdate=" + estiStockUpdate + ", estiStockRemove=" + estiStockRemove + ", unitPrice="
				+ unitPrice + "]";
	}
