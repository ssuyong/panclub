...
public class StorageUseReqItem {
	...
	//주문관련 추가 2023.03.29 hsg
	private String orderGroupId;
	private int orderCnt;
	private String storageName;
	
	private String rackCode;  // 2023.05.19 hsg
	private String rackName;
	private String rackArr;
	private String afterRackCode;   //창고사용 완료 시 이동할 창고랙코드
	
	private BigDecimal unitPrice;   //2023.08.23. hsg
	
	private String consignItemArr;  // supi db로 창고사용요청 아이템 배열들의 회수부품 여부값 1=회수 , 0=일반     "1^0^0^1" 이라면 1번째랑 4번째 부품은 회수 부품이고 2,3번째 부품은 일반 
	
	private String ctReqNo;  //2024.01.31 supi 연결된 회수요청의 번호 , 순번 , 상태
	private String ctReqSeq;
	private String ctProcStep;
	
	private String pcReqNo; // 2024.05.03 supi 주문 접수로 생성된 창고사용의 경우 연결된 주문번호
	private String pcReqSeq; //2024.05.03 supi  연결된 주문 순번

	private String logisCodeArr; //2024.06.07 yoonsang  수령물류센터
	private String rcvLogisCode; //2024.06.07 yoonsang  수령물류센터
	
	private String stockQty; //2024.06.26 supi pda-랙에 남은 재고 표시를 위한 변수
	...
	public String getConsignItemArr() {
		return consignItemArr;
	}
	public void setConsignItemArr(String consignItemArr) {
		this.consignItemArr = consignItemArr;
	}
	...
	public String getCtReqSeq() {
		return ctReqSeq;
	}
	public void setCtReqSeq(String ctReqSeq) {
		this.ctReqSeq = ctReqSeq;
	}
	public String getCtProcStep() {
		return ctProcStep;
	}
	public void setCtProcStep(String ctProcStep) {
		this.ctProcStep = ctProcStep;
	}
	...
	public String getPcReqSeq() {
		return pcReqSeq;
	}
	public void setPcReqSeq(String pcReqSeq) {
		this.pcReqSeq = pcReqSeq;
	}
	public String getLogisCodeArr() {
		return logisCodeArr;
	}
	public void setLogisCodeArr(String logisCodeArr) {
		this.logisCodeArr = logisCodeArr;
	}
	...
	public String toString() {
		return "StorageUseReqItem [workingType=" + workingType + ", db_resultCode=" + db_resultCode + ", db_resultMsg="
				...
				+ storageName + ", rackCode=" + rackCode + ", rackName=" + rackName + ", rackArr=" + rackArr
				+ ", afterRackCode=" + afterRackCode + ", unitPrice=" + unitPrice + ", consignItemArr=" + consignItemArr
				+ ", ctReqNo=" + ctReqNo + ", ctReqSeq=" + ctReqSeq + ", ctProcStep=" + ctProcStep + ", pcReqNo="
				+ pcReqNo + ", pcReqSeq=" + pcReqSeq + ", logisCodeArr=" + logisCodeArr + ", rcvLogisCode="
				+ rcvLogisCode + ", stockQty=" + stockQty + ", logisRackId=" + logisRackId + ", storConsignCustCode="
				+ storConsignCustCode + ", makerName=" + makerName + ", className=" + className + ", factoryNo="
				+ factoryNo + "]";
	}
