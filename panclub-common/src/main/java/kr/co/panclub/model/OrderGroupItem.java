...
public class OrderGroupItem {
	...
	private int ctableQty; // 2024.01.10 supi 회수 가능 수량
	private int placeableQty; //2024.02.13 supi 발주가능수량 (그린파츠의 재고중 자신이 맡긴 재고이외의 재고수량)
	...
	private String taxBillNo;  //2023.07.17 yoonsang 
	
	private int whCnt;  //입고수량 2023.08.01 hsg
	...
	private String orderReqPlaceCustCode;  // 240314 
	private String orderReqPlaceCustName;  // 240314 
	
	private String orderReqCustCode;  // 240327 
	private String orderReqCustName;  // 240327 
	private String exPlaceCustCode;  // 240327 
	private String exPlaceCustName;  // 240327 
	
	private String placeImportCnt; // 20240715 supi 수입품 수량
	private String sirChkCnt; // 재고투입 처리수량
	private String sirCnt; //재고투입 요청수량
	private String stoctInNotPlaceCnt; //20240722 supi 그링파츠발주수량
	
	
	private String className; //20240725 supi 구분,공장품번
	private String factoryNo; 
	
	private String clIgnYN; 	//240911 yoonsang 청구제외여부 추가

	private String clIgnMemo1; 	//240912 yoonsang 청구제외사유
	private String clIgnMemo2; 	//240912 yoonsang 청구제외사유
	
	private String otherSaleType; 	//250513 yoonsang 김용원재고 다른할인율적용
	...
	public String getExPlaceCustCode() {
		return exPlaceCustCode;
	}

	public void setExPlaceCustCode(String exPlaceCustCode) {
		this.exPlaceCustCode = exPlaceCustCode;
	}

	public String getExPlaceCustName() {
		return exPlaceCustName;
	}

	public void setExPlaceCustName(String exPlaceCustName) {
		this.exPlaceCustName = exPlaceCustName;
	}

	public String getPlaceImportCnt() {
		return placeImportCnt;
	}

	public void setPlaceImportCnt(String placeImportCnt) {
		this.placeImportCnt = placeImportCnt;
	}

	public String getSirChkCnt() {
		return sirChkCnt;
	}

	public void setSirChkCnt(String sirChkCnt) {
		this.sirChkCnt = sirChkCnt;
	}

	public String getSirCnt() {
		return sirCnt;
	}

	public void setSirCnt(String sirCnt) {
		this.sirCnt = sirCnt;
	}

	public String getStoctInNotPlaceCnt() {
		return stoctInNotPlaceCnt;
	}

	public void setStoctInNotPlaceCnt(String stoctInNotPlaceCnt) {
		this.stoctInNotPlaceCnt = stoctInNotPlaceCnt;
	}
	...
	public String toString() {
		return "OrderGroupItem [workingType=" + workingType + ", db_resultCode=" + db_resultCode + ", db_resultMsg="
				...
				+ ", placeSeq=" + placeSeq + ", workableQty=" + workableQty + ", ctableQty=" + ctableQty
				+ ", placeableQty=" + placeableQty + ", custCode=" + custCode + ", custName=" + custName + ", carNo="
				+ carNo + ", regUserName=" + regUserName + ", makerCode=" + makerCode + ", carType=" + carType
				+ ", rlCnt=" + rlCnt + ", clReqChkYN=" + clReqChkYN + ", minusClYN=" + minusClYN + ", branchCode="
				+ branchCode + ", taxBillNo=" + taxBillNo + ", whCnt=" + whCnt + ", rcvlogisCode=" + rcvlogisCode
				+ ", orderReqYN=" + orderReqYN + ", toOrderReqPlaceYN=" + toOrderReqPlaceYN + ", orderReqPlaceCustCode="
				+ orderReqPlaceCustCode + ", orderReqPlaceCustName=" + orderReqPlaceCustName + ", orderReqCustCode="
				+ orderReqCustCode + ", orderReqCustName=" + orderReqCustName + ", exPlaceCustCode=" + exPlaceCustCode
				+ ", exPlaceCustName=" + exPlaceCustName + ", placeImportCnt=" + placeImportCnt + ", sirChkCnt="
				+ sirChkCnt + ", sirCnt=" + sirCnt + ", stoctInNotPlaceCnt=" + stoctInNotPlaceCnt + ", className="
				+ className + ", factoryNo=" + factoryNo + ", clIgnYN=" + clIgnYN + ", clIgnMemo1=" + clIgnMemo1
				+ ", clIgnMemo2=" + clIgnMemo2 + ", otherSaleType=" + otherSaleType + "]";
	}
